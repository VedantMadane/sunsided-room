...
| Metric | Value |
|--------|------:|
| Remaining C modules | 23 |
| Total remaining LoC | 28,531 |
| Already ported LoC | ~27,169 (est.) |
| Port completeness | ~48.8% (by line count) |
