...
| Metric | Value |
|--------|------:|
| Remaining C modules | 16 |
| Total remaining LoC | 22,875 |
| Already ported LoC | ~32,825 (est.) |
| Port completeness | ~59.0% (by line count) |
