...
| Metric | Value |
|--------|------:|
| Remaining C modules | 17 |
| Total remaining LoC | 23,763 |
| Already ported LoC | ~31,937 (est.) |
| Port completeness | ~57.3% (by line count) |
