...
pub unsafe extern "C" fn P_CrossSubsector(mut num: ::core::ffi::c_int) -> boolean {
    ...
    if num >= numsubsectors {
        ...
        snprintf(
            ...
            b"P_CrossSubsector: ss %i with numss = %i\0".as_ptr() as *const ::core::ffi::c_char,
            num,
            numsubsectors,
        );
...
pub unsafe extern "C" fn P_CheckSight(mut t1: *mut mobj_t, mut t2: *mut mobj_t) -> boolean {
    ...
    s1 =
        (*(*t1).subsector).sector.offset_from(sectors) as ::core::ffi::c_long as ::core::ffi::c_int;
    s2 =
        (*(*t2).subsector).sector.offset_from(sectors) as ::core::ffi::c_long as ::core::ffi::c_int;
