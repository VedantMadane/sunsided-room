...
pub unsafe extern "C" fn T_FireFlicker(mut flick: *mut fireflicker_t) {
    ...
    if (*(*flick).sector).lightlevel as ::core::ffi::c_int - amount < (*flick).minlight {
        ...
        (*(*flick).sector).lightlevel = ((*flick).maxlight - amount) as ::core::ffi::c_short;
    }
...
pub unsafe extern "C" fn P_SpawnFireFlicker(mut sector: *mut sector_t) {
    ...
    (*flick).thinker.function.acp1 = ::core::mem::transmute::<
        ...
        actionf_p1,
    >(Some(
        T_FireFlicker as unsafe extern "C" fn(*mut fireflicker_t) -> (),
    ));
    (*flick).sector = sector;
    (*flick).maxlight = (*sector).lightlevel as ::core::ffi::c_int;
    (*flick).minlight =
        P_FindMinSurroundingLight(sector, (*sector).lightlevel as ::core::ffi::c_int)
...
pub unsafe extern "C" fn P_SpawnStrobeFlash(
    ...
    (*sector).special = 0 as ::core::ffi::c_short;
    if inSync == 0 {
        (*flash).count = (P_Random() & 7 as ::core::ffi::c_int) + 1 as ::core::ffi::c_int;
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EV_LightTurnOn(mut line: *mut line_t, mut bright: ::core::ffi::c_int) {
    let mut i: ::core::ffi::c_int = 0;
    let mut j: ::core::ffi::c_int = 0;
    let mut sector: *mut sector_t = ::core::ptr::null_mut::<sector_t>();
...
pub unsafe extern "C" fn P_SpawnGlowingLight(mut sector: *mut sector_t) {
    ...
    (*g).sector = sector;
    (*g).minlight = P_FindMinSurroundingLight(sector, (*sector).lightlevel as ::core::ffi::c_int);
