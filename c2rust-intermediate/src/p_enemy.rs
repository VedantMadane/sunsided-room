extern "C" {
    ...
    fn P_SpawnMissile(source: *mut mobj_t, dest: *mut mobj_t, type_0: mobjtype_t) -> *mut mobj_t;
    ...
    fn P_RadiusAttack(spot: *mut mobj_t, source: *mut mobj_t, damage: ::core::ffi::c_int);
    ...
    fn P_UseSpecialLine(thing: *mut mobj_t, line: *mut line_t, side: ::core::ffi::c_int)
        -> boolean;
...
pub const MF_TRANSSHIFT: C2Rust_Unnamed = 26;
pub const MF_TRANSLATION: C2Rust_Unnamed = 201326592;
pub const MF_NOTDMATCH: C2Rust_Unnamed = 33554432;
pub const MF_SKULLFLY: C2Rust_Unnamed = 16777216;
pub const MF_COUNTITEM: C2Rust_Unnamed = 8388608;
pub const MF_COUNTKILL: C2Rust_Unnamed = 4194304;
pub const MF_INFLOAT: C2Rust_Unnamed = 2097152;
pub const MF_CORPSE: C2Rust_Unnamed = 1048576;
pub const MF_NOBLOOD: C2Rust_Unnamed = 524288;
pub const MF_SHADOW: C2Rust_Unnamed = 262144;
pub const MF_DROPPED: C2Rust_Unnamed = 131072;
pub const MF_MISSILE: C2Rust_Unnamed = 65536;
pub const MF_TELEPORT: C2Rust_Unnamed = 32768;
pub const MF_FLOAT: C2Rust_Unnamed = 16384;
pub const MF_SLIDE: C2Rust_Unnamed = 8192;
pub const MF_NOCLIP: C2Rust_Unnamed = 4096;
pub const MF_PICKUP: C2Rust_Unnamed = 2048;
pub const MF_DROPOFF: C2Rust_Unnamed = 1024;
pub const MF_NOGRAVITY: C2Rust_Unnamed = 512;
pub const MF_SPAWNCEILING: C2Rust_Unnamed = 256;
pub const MF_JUSTATTACKED: C2Rust_Unnamed = 128;
pub const MF_JUSTHIT: C2Rust_Unnamed = 64;
pub const MF_AMBUSH: C2Rust_Unnamed = 32;
pub const MF_NOBLOCKMAP: C2Rust_Unnamed = 16;
pub const MF_NOSECTOR: C2Rust_Unnamed = 8;
pub const MF_SHOOTABLE: C2Rust_Unnamed = 4;
pub const MF_SOLID: C2Rust_Unnamed = 2;
pub const MF_SPECIAL: C2Rust_Unnamed = 1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mobj_s {
...
pub const MISSILERANGE: ::core::ffi::c_int =
    32 as ::core::ffi::c_int * 64 as ::core::ffi::c_int * FRACUNIT;
#[no_mangle]
...
#[no_mangle]
pub static mut soundtarget: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
    ...
    while i < (*sec).linecount {
        ...
        if !((*check).flags as ::core::ffi::c_int & ML_TWOSIDED == 0) {
            ...
            if !(openrange <= 0 as ::core::ffi::c_int) {
                if (*sides.offset((*check).sidenum[0 as ::core::ffi::c_int as usize] as isize))
                    .sector
                    == sec
                {
                    other = (*sides
                        .offset((*check).sidenum[1 as ::core::ffi::c_int as usize] as isize))
                    .sector;
                } else {
                    other = (*sides
...
pub unsafe extern "C" fn P_CheckMissileRange(mut actor: *mut mobj_t) -> boolean {
    ...
    dist = (P_AproxDistance(
        ...
        - 64 as ::core::ffi::c_int * FRACUNIT) as fixed_t;
...
pub unsafe extern "C" fn P_Move(mut actor: *mut mobj_t) -> boolean {
    ...
    if (*actor).movedir as ::core::ffi::c_uint >= 8 as ::core::ffi::c_uint {
        ...
        snprintf(
            ...
            b"Weird actor->movedir!\0".as_ptr() as *const ::core::ffi::c_char,
        );
...
pub unsafe extern "C" fn P_NewChaseDir(mut actor: *mut mobj_t) {
    ...
    if (*actor).target.is_null() {
        ...
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"P_NewChaseDir: called with no target\0".as_ptr() as *const ::core::ffi::c_char,
        );
        I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
    }
    ...
    if d[1 as ::core::ffi::c_int as usize] as ::core::ffi::c_uint
        ...
        && d[2 as ::core::ffi::c_int as usize] as ::core::ffi::c_uint
            != DI_NODIR as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        (*actor).movedir = diags[((((deltay < 0 as ::core::ffi::c_int) as ::core::ffi::c_int)
            << 1 as ::core::ffi::c_int)
            + (deltax > 0 as ::core::ffi::c_int) as ::core::ffi::c_int)
    ...
    if olddir as ::core::ffi::c_uint != DI_NODIR as ::core::ffi::c_int as ::core::ffi::c_uint {
    ...
    if turnaround as ::core::ffi::c_uint != DI_NODIR as ::core::ffi::c_int as ::core::ffi::c_uint {
    ...
    loop {
        's_20: {
            if !(playeringame[(*actor).lastlook as usize] == 0) {
                let c2rust_fresh1 = c;
                c = c + 1;
                if c2rust_fresh1 == 2 as ::core::ffi::c_int || (*actor).lastlook == stop {
                    return false_0 as boolean;
                }
        ...
        (*actor).lastlook = (*actor).lastlook + 1 as ::core::ffi::c_int & 3 as ::core::ffi::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn A_KeenDie(mut mo: *mut mobj_t) {
    ...
    while th != &raw mut thinkercap {
        if !((*th).function.acp1
            != ::core::mem::transmute::<Option<unsafe extern "C" fn(*mut mobj_t) -> ()>, actionf_p1>(
                Some(P_MobjThinker as unsafe extern "C" fn(*mut mobj_t) -> ()),
            ))
        {
            mo2 = th as *mut mobj_t;
            if mo2 != mo
                && (*mo2).type_0 as ::core::ffi::c_uint == (*mo).type_0 as ::core::ffi::c_uint
...
pub unsafe extern "C" fn A_Look(mut actor: *mut mobj_t) {
    ...
    if (*(*actor).info).seesound != 0 {
        ...
        match (*(*actor).info).seesound {
            36 | 37 | 38 => {
                sound = sfx_posit1 as ::core::ffi::c_int + P_Random() % 3 as ::core::ffi::c_int;
            }
            39 | 40 => {
                sound = sfx_bgsit1 as ::core::ffi::c_int + P_Random() % 2 as ::core::ffi::c_int;
            }
            _ => {
...
pub unsafe extern "C" fn A_Chase(mut actor: *mut mobj_t) {
    ...
    if (*actor).movedir < 8 as ::core::ffi::c_int {
        (*actor).angle &= ((7 as ::core::ffi::c_int) << 29 as ::core::ffi::c_int) as angle_t;
        delta = (*actor)
            .angle
    ...
    if (*actor).flags & MF_JUSTATTACKED as ::core::ffi::c_int != 0 {
        ...
        if gameskill as ::core::ffi::c_int != sk_nightmare as ::core::ffi::c_int && fastparm == 0 {
            P_NewChaseDir(actor);
        }
        return;
    }
...
pub unsafe extern "C" fn A_FaceTarget(mut actor: *mut mobj_t) {
    ...
    if (*(*actor).target).flags & MF_SHADOW as ::core::ffi::c_int != 0 {
        (*actor).angle = (*actor)
            .angle
            .wrapping_add((P_Random() - P_Random() << 21 as ::core::ffi::c_int) as angle_t);
    }
}
#[no_mangle]
pub unsafe extern "C" fn A_PosAttack(mut actor: *mut mobj_t) {
    ...
    damage =
        (P_Random() % 5 as ::core::ffi::c_int + 1 as ::core::ffi::c_int) * 3 as ::core::ffi::c_int;
    P_LineAttack(
        actor,
        angle as angle_t,
        MISSILERANGE,
...
pub unsafe extern "C" fn A_SPosAttack(mut actor: *mut mobj_t) {
    ...
    slope = P_AimLineAttack(actor, bangle as angle_t, MISSILERANGE) as ::core::ffi::c_int;
    i = 0 as ::core::ffi::c_int;
...
#[no_mangle]
pub static mut corpsehit: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
pub static mut vileobj: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
...
pub unsafe extern "C" fn PIT_VileCheck(mut thing: *mut mobj_t) -> boolean {
    ...
    maxdist = (*(*thing).info).radius + mobjinfo[MT_VILE as ::core::ffi::c_int as usize].radius;
    if abs((*thing).x as ::core::ffi::c_int - viletryx as ::core::ffi::c_int) > maxdist
        || abs((*thing).y as ::core::ffi::c_int - viletryy as ::core::ffi::c_int) > maxdist
    {
        return true_0 as boolean;
    }
    corpsehit = thing;
...
pub unsafe extern "C" fn A_VileChase(mut actor: *mut mobj_t) {
    ...
    if (*actor).movedir != DI_NODIR as ::core::ffi::c_int {
        ...
        xl = viletryx as ::core::ffi::c_int
            - bmaporgx as ::core::ffi::c_int
            - 32 as ::core::ffi::c_int * FRACUNIT * 2 as ::core::ffi::c_int
            >> MAPBLOCKSHIFT;
        xh = viletryx as ::core::ffi::c_int - bmaporgx as ::core::ffi::c_int
            + 32 as ::core::ffi::c_int * FRACUNIT * 2 as ::core::ffi::c_int
            >> MAPBLOCKSHIFT;
        yl = viletryy as ::core::ffi::c_int
            - bmaporgy as ::core::ffi::c_int
            - 32 as ::core::ffi::c_int * FRACUNIT * 2 as ::core::ffi::c_int
            >> MAPBLOCKSHIFT;
...
pub unsafe extern "C" fn A_Fire(mut actor: *mut mobj_t) {
    ...
    (*actor).x = (*dest).x + FixedMul(24 as fixed_t * FRACUNIT, *finecosine.offset(an as isize));
...
pub unsafe extern "C" fn A_VileAttack(mut actor: *mut mobj_t) {
    ...
    (*(*actor).target).momz =
        (1000 as ::core::ffi::c_int * FRACUNIT / (*(*(*actor).target).info).mass) as fixed_t;
    ...
    (*fire).x =
        (*(*actor).target).x - FixedMul(24 as fixed_t * FRACUNIT, *finecosine.offset(an as isize));
...
pub unsafe extern "C" fn A_SkullAttack(mut actor: *mut mobj_t) {
    ...
    dist = P_AproxDistance((*dest).x - (*actor).x, (*dest).y - (*actor).y) as ::core::ffi::c_int;
...
pub unsafe extern "C" fn A_PainShootSkull(mut actor: *mut mobj_t, mut angle: angle_t) {
    ...
    prestep = 4 as ::core::ffi::c_int * FRACUNIT
        + 3 as ::core::ffi::c_int
            * ((*(*actor).info).radius + mobjinfo[MT_SKULL as ::core::ffi::c_int as usize].radius)
            / 2 as ::core::ffi::c_int;
    ...
    z = ((*actor).z as ::core::ffi::c_int + 8 as ::core::ffi::c_int * FRACUNIT) as fixed_t;
...
pub unsafe extern "C" fn A_Scream(mut actor: *mut mobj_t) {
    ...
    match (*(*actor).info).deathsound {
        0 => return,
        59 | 60 | 61 => {
            sound = sfx_podth1 as ::core::ffi::c_int + P_Random() % 3 as ::core::ffi::c_int;
        }
        62 | 63 => {
            sound = sfx_bgdth1 as ::core::ffi::c_int + P_Random() % 2 as ::core::ffi::c_int;
        }
        _ => {
...
unsafe extern "C" fn CheckBossEnd(mut motype: mobjtype_t) -> boolean {
        ...
        < exe_ultimate as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        ...
        if motype as ::core::ffi::c_uint == MT_BRUISER as ::core::ffi::c_int as ::core::ffi::c_uint
        ...
        match gameepisode {
            ...
            _ => {
                return (gamemap == 8 as ::core::ffi::c_int) as ::core::ffi::c_int as boolean;
            }
        }
    };
}
...
pub unsafe extern "C" fn A_BossDeath(mut mo: *mut mobj_t) {
    ...
    i = 0 as ::core::ffi::c_int;
    while i < MAXPLAYERS {
        if playeringame[i as usize] != 0 && players[i as usize].health > 0 as ::core::ffi::c_int {
            break;
        }
        i += 1;
    }
...
#[no_mangle]
pub static mut braintargets: [*mut mobj_t; 32] = [::core::ptr::null_mut::<mobj_t>(); 32];
#[no_mangle]
...
pub unsafe extern "C" fn A_BrainExplode(mut mo: *mut mobj_t) {
    ...
    let mut z: ::core::ffi::c_int = 0;
    let mut th: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
    x = (*mo).x as ::core::ffi::c_int + (P_Random() - P_Random()) * 2048 as ::core::ffi::c_int;
...
pub unsafe extern "C" fn A_BrainSpit(mut mo: *mut mobj_t) {
    ...
    (*newmobj).reactiontime = ((*targ).y as ::core::ffi::c_int - (*mo).y as ::core::ffi::c_int)
        / (*newmobj).momy as ::core::ffi::c_int
        / (*(*newmobj).state).tics;
