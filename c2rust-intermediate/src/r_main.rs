extern "C" {
    ...
    fn SlopeDiv(num: ::core::ffi::c_uint, den: ::core::ffi::c_uint) -> ::core::ffi::c_int;
...
#[no_mangle]
pub static mut fixedcolormap: *mut lighttable_t = ::core::ptr::null_mut::<lighttable_t>();
#[no_mangle]
...
#[no_mangle]
pub static mut viewplayer: *mut player_t = ::core::ptr::null_mut::<player_t>();
#[no_mangle]
...
pub static mut scalelight: [[*mut lighttable_t; 48]; 16] =
    [[::core::ptr::null_mut::<lighttable_t>(); 48]; 16];
#[no_mangle]
pub static mut scalelightfixed: [*mut lighttable_t; 48] =
    [::core::ptr::null_mut::<lighttable_t>(); 48];
#[no_mangle]
pub static mut zlight: [[*mut lighttable_t; 128]; 16] =
    [[::core::ptr::null_mut::<lighttable_t>(); 128]; 16];
#[no_mangle]
...
pub unsafe extern "C" fn R_PointOnSide(
    ...
    if ((*node).dy ^ (*node).dx ^ dx ^ dy) as ::core::ffi::c_uint
        ...
        != 0
    {
        if ((*node).dy ^ dx) as ::core::ffi::c_uint & 0x80000000 as ::core::ffi::c_uint != 0 {
...
pub unsafe extern "C" fn R_PointOnSegSide(
    ...
    dx = x - lx;
    dy = y - ly;
    if (ldy ^ ldx ^ dx ^ dy) as ::core::ffi::c_uint & 0x80000000 as ::core::ffi::c_uint != 0 {
...
pub unsafe extern "C" fn R_PointToAngle(mut x: fixed_t, mut y: fixed_t) -> angle_t {
    ...
    if x >= 0 as ::core::ffi::c_int {
        if y >= 0 as ::core::ffi::c_int {
            if x > y {
                return tantoangle
                    [SlopeDiv(y as ::core::ffi::c_uint, x as ::core::ffi::c_uint) as usize];
            } else {
                return ((ANG90 - 1 as ::core::ffi::c_int) as angle_t).wrapping_sub(
                    tantoangle
                        [SlopeDiv(x as ::core::ffi::c_uint, y as ::core::ffi::c_uint) as usize],
                );
            }
        } else {
            y = -y;
        ...
        if y >= 0 as ::core::ffi::c_int {
            if x > y {
                return ANG180.wrapping_sub(1 as angle_t).wrapping_sub(
                    tantoangle
                        [SlopeDiv(y as ::core::ffi::c_uint, x as ::core::ffi::c_uint) as usize],
                );
            } else {
                return (ANG90 as angle_t).wrapping_add(
                    tantoangle
                        [SlopeDiv(x as ::core::ffi::c_uint, y as ::core::ffi::c_uint) as usize],
                );
            }
            ...
            y = -y;
            if x > y {
                return ANG180.wrapping_add(
                    tantoangle
                        [SlopeDiv(y as ::core::ffi::c_uint, x as ::core::ffi::c_uint) as usize],
                );
            } else {
                return ANG270.wrapping_sub(1 as angle_t).wrapping_sub(
                    tantoangle
                        [SlopeDiv(x as ::core::ffi::c_uint, y as ::core::ffi::c_uint) as usize],
                );
            }
...
pub unsafe extern "C" fn R_InitTextureMapping() {
    ...
    focallength = FixedDiv(
        centerxfrac,
        finetangent[(FINEANGLES / 4 as ::core::ffi::c_int + FIELDOFVIEW / 2 as ::core::ffi::c_int)
            as usize],
    );
    ...
    while i < FINEANGLES / 2 as ::core::ffi::c_int {
        if finetangent[i as usize] > FRACUNIT * 2 as ::core::ffi::c_int {
            ...
            t = centerxfrac as ::core::ffi::c_int - t + FRACUNIT - 1 as ::core::ffi::c_int
                >> FRACBITS;
...
pub unsafe extern "C" fn R_InitLightTables() {
    ...
    while i < LIGHTLEVELS {
        startmap =
            (LIGHTLEVELS - 1 as ::core::ffi::c_int - i) * 2 as ::core::ffi::c_int * NUMCOLORMAPS
                / LIGHTLEVELS;
        ...
        while j < MAXLIGHTZ {
            ...
            zlight[i as usize][j as usize] =
                colormaps.offset((level * 256 as ::core::ffi::c_int) as isize);
            j += 1;
        }
        i += 1;
    }
...
pub unsafe extern "C" fn R_ExecuteSetViewSize() {
    ...
    while i < LIGHTLEVELS {
        ...
        while j < MAXLIGHTSCALE {
            ...
            scalelight[i as usize][j as usize] =
                colormaps.offset((level * 256 as ::core::ffi::c_int) as isize);
            j += 1;
        }
        i += 1;
