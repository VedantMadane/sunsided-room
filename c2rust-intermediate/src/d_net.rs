extern "C" {
    ...
    fn D_StartNetGame(settings: *mut net_gamesettings_t, callback: netgame_startup_callback_t);
...
pub type netgame_startup_callback_t =
    Option<unsafe extern "C" fn(::core::ffi::c_int, ::core::ffi::c_int) -> boolean>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct loop_interface_t {
    pub ProcessEvents: Option<unsafe extern "C" fn() -> ()>,
    pub BuildTiccmd: Option<unsafe extern "C" fn(*mut ticcmd_t, ::core::ffi::c_int) -> ()>,
...
#[no_mangle]
pub static mut netcmds: *mut ticcmd_t = ::core::ptr::null_mut::<ticcmd_t>();
unsafe extern "C" fn PlayerQuitGame(mut player: *mut player_t) {
    ...
    player_num = player.offset_from(&raw mut players as *mut player_t) as ::core::ffi::c_long
        as ::core::ffi::c_uint;
    M_StringCopy(
        &raw mut exitmsg as *mut ::core::ffi::c_char,
        b"Player 1 left the game\0".as_ptr() as *const ::core::ffi::c_char,
        ::core::mem::size_of::<[::core::ffi::c_char; 80]>() as size_t,
    );
    exitmsg[7 as ::core::ffi::c_int as usize] =
        (exitmsg[7 as ::core::ffi::c_int as usize] as ::core::ffi::c_uint).wrapping_add(player_num)
            as ::core::ffi::c_char;
...
unsafe extern "C" fn RunTic(mut cmds: *mut ticcmd_t, mut ingame: *mut boolean) {
    ...
    while i < MAXPLAYERS as ::core::ffi::c_uint {
        if demoplayback == 0 && playeringame[i as usize] != 0 && *ingame.offset(i as isize) == 0 {
...
static mut doom_loop_interface: loop_interface_t = loop_interface_t {
    ...
    BuildTiccmd: Some(
        G_BuildTiccmd as unsafe extern "C" fn(*mut ticcmd_t, ::core::ffi::c_int) -> (),
    ),
...
unsafe extern "C" fn LoadGameSettings(mut settings: *mut net_gamesettings_t) {
    ...
    i = 0 as ::core::ffi::c_uint;
    while i < MAXPLAYERS as ::core::ffi::c_uint {
        playeringame[i as usize] =
            (i < (*settings).num_players as ::core::ffi::c_uint) as ::core::ffi::c_int as boolean;
        i = i.wrapping_add(1);
    }
}
...
unsafe extern "C" fn InitConnectData(mut connect_data: *mut net_connect_data_t) {
    ...
    if M_CheckParm(b"-left\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char)
        > 0 as ::core::ffi::c_int
    {
        viewangleoffset = ANG90;
        (*connect_data).drone = true_0;
    }
    if M_CheckParm(b"-right\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char)
        > 0 as ::core::ffi::c_int
    {
    ...
    (*connect_data).is_freedoom = (W_CheckNumForName(b"FREEDOOM\0".as_ptr()
...
pub unsafe extern "C" fn D_ConnectNetGame() {
    ...
    if M_CheckParm(b"-solo-net\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char)
        > 0 as ::core::ffi::c_int
    {
...
pub unsafe extern "C" fn D_CheckNetGame() {
    ...
    if timelimit > 0 as ::core::ffi::c_int && deathmatch != 0 {
        if timelimit == 20 as ::core::ffi::c_int
            && M_CheckParm(
                b"-avg\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
            ) != 0
        {
            printf(
            ...
            printf(
                b"Levels will end after %d minute\0".as_ptr() as *const ::core::ffi::c_char,
                timelimit,
            );
            if timelimit > 1 as ::core::ffi::c_int {
                printf(b"s\0".as_ptr() as *const ::core::ffi::c_char);
            }
            printf(b".\n\0".as_ptr() as *const ::core::ffi::c_char);
        }
    }
