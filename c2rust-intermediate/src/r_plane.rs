...
#[no_mangle]
pub static mut lastvisplane: *mut visplane_t = ::core::ptr::null_mut::<visplane_t>();
#[no_mangle]
pub static mut floorplane: *mut visplane_t = ::core::ptr::null_mut::<visplane_t>();
#[no_mangle]
pub static mut ceilingplane: *mut visplane_t = ::core::ptr::null_mut::<visplane_t>();
#[no_mangle]
pub static mut openings: [::core::ffi::c_short; 20480] = [0; 20480];
#[no_mangle]
pub static mut lastopening: *mut ::core::ffi::c_short =
...
#[no_mangle]
pub static mut planezlight: *mut *mut lighttable_t = ::core::ptr::null_mut::<*mut lighttable_t>();
#[no_mangle]
...
pub unsafe extern "C" fn R_MapPlane(
    ...
    if x2 < x1 || x1 < 0 as ::core::ffi::c_int || x2 >= viewwidth || y > viewheight {
        ...
        snprintf(
            ...
            b"R_MapPlane: %i, %i at %i\0".as_ptr() as *const ::core::ffi::c_char,
            x1,
            x2,
            y,
        );
...
pub unsafe extern "C" fn R_ClearPlanes() {
    ...
    while i < viewwidth {
        ...
        ceilingclip[i as usize] = -1 as ::core::ffi::c_short;
        i += 1;
    }
...
pub unsafe extern "C" fn R_FindPlane(
    ...
    if lastvisplane.offset_from(&raw mut visplanes as *mut visplane_t) as ::core::ffi::c_long
        == MAXVISPLANES as ::core::ffi::c_long
    {
        let mut _i_err_buf: [::core::ffi::c_char; 512] = [0; 512];
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_FindPlane: no more visplanes\0".as_ptr() as *const ::core::ffi::c_char,
        );
        I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
    }
...
pub unsafe extern "C" fn R_CheckPlane(
    ...
    let c2rust_fresh0 = lastvisplane;
    lastvisplane = lastvisplane.offset(1);
    pl = c2rust_fresh0;
    (*pl).minx = start;
    (*pl).maxx = stop;
...
pub unsafe extern "C" fn R_DrawPlanes() {
        ...
        > MAXDRAWSEGS as ::core::ffi::c_long
    {
        ...
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_DrawPlanes: drawsegs overflow (%i)\0".as_ptr() as *const ::core::ffi::c_char,
        ...
        > MAXVISPLANES as ::core::ffi::c_long
    {
        ...
        snprintf(
            ...
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_DrawPlanes: visplane overflow (%i)\0".as_ptr() as *const ::core::ffi::c_char,
            lastvisplane.offset_from(&raw mut visplanes as *mut visplane_t) as ::core::ffi::c_long,
        );
        ...
        > (SCREENWIDTH * 64 as ::core::ffi::c_int) as ::core::ffi::c_long
    {
        ...
        snprintf(
            ...
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_DrawPlanes: opening overflow (%i)\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    while pl < lastvisplane {
        if !((*pl).minx > (*pl).maxx) {
            if (*pl).picnum == skyflatnum {
                ...
                ds_source = W_CacheLumpNum(lumpnum, PU_STATIC as ::core::ffi::c_int) as *mut byte;
                planeheight = abs((*pl).height as ::core::ffi::c_int - viewz as ::core::ffi::c_int)
                    as fixed_t;
                ...
                (*pl).top[((*pl).maxx + 1 as ::core::ffi::c_int) as usize] = 0xff as byte;
                (*pl).top[((*pl).minx - 1 as ::core::ffi::c_int) as usize] = 0xff as byte;
                stop = (*pl).maxx + 1 as ::core::ffi::c_int;
                x = (*pl).minx;
                while x <= stop {
                    R_MakeSpans(
                        x,
                        (*pl).top[(x - 1 as ::core::ffi::c_int) as usize] as ::core::ffi::c_int,
                        (*pl).bottom[(x - 1 as ::core::ffi::c_int) as usize] as ::core::ffi::c_int,
