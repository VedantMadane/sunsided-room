...
pub const CF_NOMOMENTUM: C2Rust_Unnamed_0 = 4;
pub const CF_GODMODE: C2Rust_Unnamed_0 = 2;
pub const CF_NOCLIP: C2Rust_Unnamed_0 = 1;
...
#[no_mangle]
pub static mut lastanim: *mut anim_t = ::core::ptr::null_mut::<anim_t>();
...
pub unsafe extern "C" fn P_InitPicAnims() {
    ...
    while animdefs[i as usize].istexture != -1 as ::core::ffi::c_int {
        ...
        's_9: {
            ...
            (*lastanim).numpics =
                (*lastanim).picnum - (*lastanim).basepic + 1 as ::core::ffi::c_int;
            if (*lastanim).numpics < 2 as ::core::ffi::c_int {
                ...
                snprintf(
                    ...
                    b"P_InitPicAnims: bad cycle from %s to %s\0".as_ptr()
    ...
    while i < (*sec).linecount {
        ...
        if !other.is_null() {
            if (*other).floorheight > height {
                ...
                let c2rust_fresh1 = h;
                h = h + 1;
                heightlist[c2rust_fresh1 as usize] = (*other).floorheight;
            }
        }
        i += 1;
    }
    ...
    match (*sector).special as ::core::ffi::c_int {
        ...
        _ => {
            ...
            snprintf(
                &raw mut _i_err_buf as *mut ::core::ffi::c_char,
                ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
                b"P_PlayerInSpecialSector: unknown special %i\0".as_ptr()
                    as *const ::core::ffi::c_char,
        ...
        if buttonlist[i as usize].btimer != 0 {
            ...
            if buttonlist[i as usize].btimer == 0 {
                match buttonlist[i as usize].where_0 as ::core::ffi::c_uint {
                    0 => {
                        (*sides.offset(
                            (*buttonlist[i as usize].line).sidenum[0 as ::core::ffi::c_int as usize]
                                as isize,
                        ))
                        .toptexture = buttonlist[i as usize].btexture as ::core::ffi::c_short;
                    }
                    1 => {
                        (*sides.offset(
                            (*buttonlist[i as usize].line).sidenum[0 as ::core::ffi::c_int as usize]
                        ...
                        .midtexture = buttonlist[i as usize].btexture as ::core::ffi::c_short;
                    }
                    2 => {
                        (*sides.offset(
                            (*buttonlist[i as usize].line).sidenum[0 as ::core::ffi::c_int as usize]
                        ...
                        .bottomtexture = buttonlist[i as usize].btexture as ::core::ffi::c_short;
                    }
                    _ => {}
                }
                S_StartSound(
                    &raw mut (*(&raw mut buttonlist as *mut button_t).offset(i as isize)).soundorg
...
unsafe extern "C" fn DonutOverrun(
    ...
    if first != 0 {
        ...
        p = M_CheckParmWithArgs(
            b"-donut\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            2 as ::core::ffi::c_int,
        );
...
#[no_mangle]
pub static mut linespeciallist: [*mut line_t; 64] = [::core::ptr::null_mut::<line_t>(); 64];
#[no_mangle]
