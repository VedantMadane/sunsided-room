...
#[no_mangle]
pub static mut walllights: *mut *mut lighttable_t = ::core::ptr::null_mut::<*mut lighttable_t>();
#[no_mangle]
pub static mut maskedtexturecol: *mut ::core::ffi::c_short =
...
pub unsafe extern "C" fn R_RenderMaskedSegRange(
    ...
    lightnum = ((*frontsector).lightlevel as ::core::ffi::c_int >> LIGHTSEGSHIFT) + extralight;
...
pub unsafe extern "C" fn R_RenderSegLoop() {
    ...
    while rw_x < rw_stopx {
        yl = topfrac as ::core::ffi::c_int + HEIGHTUNIT - 1 as ::core::ffi::c_int >> HEIGHTBITS;
        if yl < ceilingclip[rw_x as usize] as ::core::ffi::c_int + 1 as ::core::ffi::c_int {
            yl = ceilingclip[rw_x as usize] as ::core::ffi::c_int + 1 as ::core::ffi::c_int;
        }
        if markceiling != 0 {
            top = ceilingclip[rw_x as usize] as ::core::ffi::c_int + 1 as ::core::ffi::c_int;
            bottom = yl - 1 as ::core::ffi::c_int;
            if bottom >= floorclip[rw_x as usize] as ::core::ffi::c_int {
                bottom = floorclip[rw_x as usize] as ::core::ffi::c_int - 1 as ::core::ffi::c_int;
            }
            if top <= bottom {
        ...
        if yh >= floorclip[rw_x as usize] as ::core::ffi::c_int {
            yh = floorclip[rw_x as usize] as ::core::ffi::c_int - 1 as ::core::ffi::c_int;
        }
        if markfloor != 0 {
        ...
        if midtexture != 0 {
            ...
            floorclip[rw_x as usize] = -1 as ::core::ffi::c_short;
        } else {
            if toptexture != 0 {
                mid = (pixhigh >> HEIGHTBITS) as ::core::ffi::c_int;
                pixhigh += pixhighstep;
                if mid >= floorclip[rw_x as usize] as ::core::ffi::c_int {
                    mid = floorclip[rw_x as usize] as ::core::ffi::c_int - 1 as ::core::ffi::c_int;
                }
                if mid >= yl {
                    dc_yl = yl;
                    dc_yh = mid;
                    dc_texturemid = rw_toptexturemid;
                    dc_source = R_GetColumn(toptexture, texturecolumn as ::core::ffi::c_int);
                    colfunc.expect("non-null function pointer")();
                    ceilingclip[rw_x as usize] = mid as ::core::ffi::c_short;
                } else {
                    ceilingclip[rw_x as usize] =
                        (yl - 1 as ::core::ffi::c_int) as ::core::ffi::c_short;
                }
            } else if markceiling != 0 {
                ceilingclip[rw_x as usize] = (yl - 1 as ::core::ffi::c_int) as ::core::ffi::c_short;
            }
            if bottomtexture != 0 {
                ...
                if mid <= yh {
                    ...
                    dc_source = R_GetColumn(bottomtexture, texturecolumn as ::core::ffi::c_int);
                    colfunc.expect("non-null function pointer")();
                    floorclip[rw_x as usize] = mid as ::core::ffi::c_short;
                } else {
                    floorclip[rw_x as usize] =
                        (yh + 1 as ::core::ffi::c_int) as ::core::ffi::c_short;
                }
            } else if markfloor != 0 {
                floorclip[rw_x as usize] = (yh + 1 as ::core::ffi::c_int) as ::core::ffi::c_short;
            }
            if maskedtexture != 0 {
                *maskedtexturecol.offset(rw_x as isize) = texturecolumn as ::core::ffi::c_short;
            }
        }
...
pub unsafe extern "C" fn R_StoreWallRange(
    ...
    if start >= viewwidth || start > stop {
        ...
        snprintf(
            ...
            b"Bad R_RenderWallRange: %i to %i\0".as_ptr() as *const ::core::ffi::c_char,
            start,
            stop,
        );
    ...
    (*linedef).flags = ((*linedef).flags as ::core::ffi::c_int | ML_MAPPED) as ::core::ffi::c_short;
    rw_normalangle = (*curline).angle.wrapping_add(ANG90 as angle_t);
    offsetangle =
        abs(rw_normalangle.wrapping_sub(rw_angle1 as angle_t) as ::core::ffi::c_int) as angle_t;
    ...
    if stop > start {
        ...
        rw_scalestep = (((*ds_p).scale2 as ::core::ffi::c_int - rw_scale as ::core::ffi::c_int)
    ...
    if segtextured != 0 {
        ...
        if fixedcolormap.is_null() {
            lightnum =
                ((*frontsector).lightlevel as ::core::ffi::c_int >> LIGHTSEGSHIFT) + extralight;
            if (*(*curline).v1).y == (*(*curline).v2).y {
                lightnum -= 1;
            } else if (*(*curline).v1).x == (*(*curline).v2).x {
                lightnum += 1;
    ...
    topfrac = (centeryfrac >> 4 as ::core::ffi::c_int) - FixedMul(worldtop as fixed_t, rw_scale);
    bottomstep = -FixedMul(rw_scalestep, worldbottom as fixed_t);
    bottomfrac =
        (centeryfrac >> 4 as ::core::ffi::c_int) - FixedMul(worldbottom as fixed_t, rw_scale);
    if !backsector.is_null() {
        worldhigh >>= 4 as ::core::ffi::c_int;
        worldlow >>= 4 as ::core::ffi::c_int;
        if worldhigh < worldtop {
            pixhigh =
                (centeryfrac >> 4 as ::core::ffi::c_int) - FixedMul(worldhigh as fixed_t, rw_scale);
            pixhighstep = -FixedMul(rw_scalestep, worldhigh as fixed_t);
        }
        if worldlow > worldbottom {
            pixlow =
                (centeryfrac >> 4 as ::core::ffi::c_int) - FixedMul(worldlow as fixed_t, rw_scale);
            pixlowstep = -FixedMul(rw_scalestep, worldlow as fixed_t);
        }
    }
    if markceiling != 0 {
        ceilingplane = R_CheckPlane(ceilingplane, rw_x, rw_stopx - 1 as ::core::ffi::c_int);
    }
    if markfloor != 0 {
