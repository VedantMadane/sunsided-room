extern "C" {
    ...
    fn R_RenderMaskedSegRange(ds: *mut drawseg_t, x1: ::core::ffi::c_int, x2: ::core::ffi::c_int);
...
pub const PU_NUM_TAGS: C2Rust_Unnamed_0 = 9;
pub const PU_CACHE: C2Rust_Unnamed_0 = 8;
pub const PU_PURGELEVEL: C2Rust_Unnamed_0 = 7;
pub const PU_LEVSPEC: C2Rust_Unnamed_0 = 6;
pub const PU_LEVEL: C2Rust_Unnamed_0 = 5;
pub const PU_FREE: C2Rust_Unnamed_0 = 4;
pub const PU_MUSIC: C2Rust_Unnamed_0 = 3;
pub const PU_SOUND: C2Rust_Unnamed_0 = 2;
pub const PU_STATIC: C2Rust_Unnamed_0 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub static mut spritelights: *mut *mut lighttable_t = ::core::ptr::null_mut::<*mut lighttable_t>();
#[no_mangle]
pub static mut negonearray: [::core::ffi::c_short; 320] = [0; 320];
#[no_mangle]
pub static mut screenheightarray: [::core::ffi::c_short; 320] = [0; 320];
#[no_mangle]
pub static mut sprites: *mut spritedef_t = ::core::ptr::null_mut::<spritedef_t>();
#[no_mangle]
...
pub unsafe extern "C" fn R_InstallSpriteLump(
    ...
    if frame >= 29 as ::core::ffi::c_uint || rotation > 8 as ::core::ffi::c_uint {
        ...
        snprintf(
            ...
            b"R_InstallSpriteLump: Bad frame characters in lump %i\0".as_ptr()
    ...
    if rotation == 0 as ::core::ffi::c_uint {
        if sprtemp[frame as usize].rotate == false_0 as boolean {
            ...
            snprintf(
                ...
                b"R_InitSprites: Sprite %s frame %c has multip rot=0 lump\0".as_ptr()
                    as *const ::core::ffi::c_char,
                spritename,
                ('A' as ::core::ffi::c_uint).wrapping_add(frame),
            );
        ...
        while r < 8 as ::core::ffi::c_int {
            sprtemp[frame as usize].lump[r as usize] =
                (lump - firstspritelump) as ::core::ffi::c_short;
    ...
    if sprtemp[frame as usize].rotate == false_0 as boolean {
        let mut _i_err_buf_2: [::core::ffi::c_char; 512] = [0; 512];
        snprintf(
            &raw mut _i_err_buf_2 as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_InitSprites: Sprite %s frame %c has rotations and a rot=0 lump\0".as_ptr()
                as *const ::core::ffi::c_char,
            spritename,
        ...
        I_ErrorV(&raw mut _i_err_buf_2 as *mut ::core::ffi::c_char);
    }
    ...
    if sprtemp[frame as usize].lump[rotation as usize] as ::core::ffi::c_int
        != -1 as ::core::ffi::c_int
    {
        let mut _i_err_buf_3: [::core::ffi::c_char; 512] = [0; 512];
        snprintf(
            &raw mut _i_err_buf_3 as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_InitSprites: Sprite %s : %c : %c has two lumps mapped to it\0".as_ptr()
                as *const ::core::ffi::c_char,
            spritename,
            ('A' as ::core::ffi::c_uint).wrapping_add(frame),
            ('1' as ::core::ffi::c_uint).wrapping_add(rotation),
        );
        I_ErrorV(&raw mut _i_err_buf_3 as *mut ::core::ffi::c_char);
    }
    sprtemp[frame as usize].lump[rotation as usize] =
        (lump - firstspritelump) as ::core::ffi::c_short;
...
pub unsafe extern "C" fn R_InitSpriteDefs(mut namelist: *mut *mut ::core::ffi::c_char) {
    ...
    numsprites = check.offset_from(namelist) as ::core::ffi::c_long as ::core::ffi::c_int;
    if numsprites == 0 {
        return;
    }
    sprites = Z_Malloc(
        (numsprites as usize).wrapping_mul(::core::mem::size_of::<spritedef_t>() as usize)
            as ::core::ffi::c_int,
    ...
    while i < numsprites {
        ...
        while l < end {
            ...
            {
                frame = (*lumpinfo.offset(l as isize)).name[4 as ::core::ffi::c_int as usize]
                    as ::core::ffi::c_int
                    - 'A' as ::core::ffi::c_int;
                rotation = (*lumpinfo.offset(l as isize)).name[5 as ::core::ffi::c_int as usize]
                    as ::core::ffi::c_int
                    - '0' as ::core::ffi::c_int;
                if modifiedgame != 0 {
                ...
                if (*lumpinfo.offset(l as isize)).name[6 as ::core::ffi::c_int as usize] != 0 {
                    frame = (*lumpinfo.offset(l as isize)).name[6 as ::core::ffi::c_int as usize]
                        as ::core::ffi::c_int
                        - 'A' as ::core::ffi::c_int;
                    rotation = (*lumpinfo.offset(l as isize)).name[7 as ::core::ffi::c_int as usize]
                        as ::core::ffi::c_int
                        - '0' as ::core::ffi::c_int;
                    R_InstallSpriteLump(
                        l,
        ...
        if maxframe == -1 as ::core::ffi::c_int {
            ...
            let ref mut c2rust_fresh1 = (*sprites.offset(i as isize)).spriteframes;
            *c2rust_fresh1 = Z_Malloc(
...
#[no_mangle]
pub static mut vissprites: [vissprite_t; 128] = [vissprite_t {
    prev: ::core::ptr::null_mut::<vissprite_s>(),
    next: ::core::ptr::null_mut::<vissprite_s>(),
    x1: 0,
    x2: 0,
    gx: 0,
    gy: 0,
    ...
    texturemid: 0,
    patch: 0,
    colormap: ::core::ptr::null_mut::<lighttable_t>(),
    mobjflags: 0,
}; 128];
#[no_mangle]
pub static mut vissprite_p: *mut vissprite_t = ::core::ptr::null_mut::<vissprite_t>();
#[no_mangle]
...
pub unsafe extern "C" fn R_InitSprites(mut namelist: *mut *mut ::core::ffi::c_char) {
    ...
    i = 0 as ::core::ffi::c_int;
    while i < SCREENWIDTH {
        negonearray[i as usize] = -1 as ::core::ffi::c_short;
        i += 1;
    }
...
#[no_mangle]
pub static mut overflowsprite: vissprite_t = vissprite_t {
    prev: ::core::ptr::null_mut::<vissprite_s>(),
    next: ::core::ptr::null_mut::<vissprite_s>(),
    x1: 0,
    x2: 0,
...
#[no_mangle]
pub static mut mfloorclip: *mut ::core::ffi::c_short =
    ::core::ptr::null_mut::<::core::ffi::c_short>();
#[no_mangle]
pub static mut mceilingclip: *mut ::core::ffi::c_short =
    ::core::ptr::null_mut::<::core::ffi::c_short>();
#[no_mangle]
...
pub unsafe extern "C" fn R_DrawMaskedColumn(mut column: *mut column_t) {
    ...
    while (*column).topdelta as ::core::ffi::c_int != 0xff as ::core::ffi::c_int {
        ...
        bottomscreen =
            topscreen + spryscale as ::core::ffi::c_int * (*column).length as ::core::ffi::c_int;
        ...
        if dc_yh >= *mfloorclip.offset(dc_x as isize) as ::core::ffi::c_int {
            dc_yh =
                *mfloorclip.offset(dc_x as isize) as ::core::ffi::c_int - 1 as ::core::ffi::c_int;
        }
        if dc_yl <= *mceilingclip.offset(dc_x as isize) as ::core::ffi::c_int {
            dc_yl =
                *mceilingclip.offset(dc_x as isize) as ::core::ffi::c_int + 1 as ::core::ffi::c_int;
        }
        if dc_yl <= dc_yh {
            dc_source = (column as *mut byte).offset(3 as ::core::ffi::c_int as isize);
            dc_texturemid = (basetexturemid as ::core::ffi::c_int
                - (((*column).topdelta as ::core::ffi::c_int) << FRACBITS))
                as fixed_t;
    ...
    while dc_x <= (*vis).x2 {
            ...
            || texturecolumn >= (*patch).width as ::core::ffi::c_int
        {
            ...
            snprintf(
                &raw mut _i_err_buf as *mut ::core::ffi::c_char,
                ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
                b"R_DrawSpriteRange: bad texturecolumn\0".as_ptr() as *const ::core::ffi::c_char,
            );
            I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
        }
        column = (patch as *mut byte).offset((*patch).columnofs[texturecolumn as usize] as isize)
            as *mut column_t;
...
pub unsafe extern "C" fn R_ProjectSprite(mut thing: *mut mobj_t) {
    ...
    if (*thing).sprite as ::core::ffi::c_uint >= numsprites as ::core::ffi::c_uint {
        ...
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_ProjectSprite: invalid sprite number %i \0".as_ptr() as *const ::core::ffi::c_char,
    ...
    if (*thing).frame & FF_FRAMEMASK >= (*sprdef).numframes {
        if (*sprdef).numframes == 0 as ::core::ffi::c_int {
            return;
        }
        let mut _i_err_buf_0: [::core::ffi::c_char; 512] = [0; 512];
        snprintf(
    ...
    (*vis).x1 = if x1 < 0 as ::core::ffi::c_int {
        0 as ::core::ffi::c_int
    } else {
        x1
    };
    (*vis).x2 = if x2 >= viewwidth {
        viewwidth - 1 as ::core::ffi::c_int
    } else {
        x2
    };
...
pub unsafe extern "C" fn R_DrawPSprite(mut psp: *mut pspdef_t) {
    ...
    let mut flip: boolean = 0;
    let mut vis: *mut vissprite_t = ::core::ptr::null_mut::<vissprite_t>();
    let mut avis: vissprite_t = vissprite_t {
        prev: ::core::ptr::null_mut::<vissprite_s>(),
        next: ::core::ptr::null_mut::<vissprite_s>(),
        x1: 0,
        x2: 0,
    ...
    lump = (*sprframe).lump[0 as ::core::ffi::c_int as usize] as ::core::ffi::c_int;
    flip = (*sprframe).flip[0 as ::core::ffi::c_int as usize] as boolean;
    tx = ((*psp).sx as ::core::ffi::c_int - 160 as ::core::ffi::c_int * FRACUNIT) as fixed_t;
    tx -= *spriteoffset.offset(lump as isize);
    ...
    tx += *spritewidth.offset(lump as isize);
    x2 = (centerxfrac as ::core::ffi::c_int + FixedMul(tx, pspritescale) as ::core::ffi::c_int
        >> FRACBITS)
        - 1 as ::core::ffi::c_int;
    if x2 < 0 as ::core::ffi::c_int {
        return;
            ...
            != 0
    {
        ...
        (*vis).colormap = *spritelights.offset((MAXLIGHTSCALE - 1 as ::core::ffi::c_int) as isize);
    }
...
pub unsafe extern "C" fn R_DrawPlayerSprites() {
    ...
    lightnum = ((*(*(*(*viewplayer).mo).subsector).sector).lightlevel as ::core::ffi::c_int
        >> LIGHTSEGSHIFT)
        + extralight;
    if lightnum < 0 as ::core::ffi::c_int {
        spritelights = &raw mut *(&raw mut scalelight as *mut [*mut lighttable_t; 48])
...
#[no_mangle]
pub static mut vsprsortedhead: vissprite_t = vissprite_t {
    prev: ::core::ptr::null_mut::<vissprite_s>(),
    next: ::core::ptr::null_mut::<vissprite_s>(),
    x1: 0,
    x2: 0,
...
pub unsafe extern "C" fn R_SortVisSprites() {
    ...
    let mut unsorted: vissprite_t = vissprite_t {
        prev: ::core::ptr::null_mut::<vissprite_s>(),
        next: ::core::ptr::null_mut::<vissprite_s>(),
        x1: 0,
        x2: 0,
    ...
    count = vissprite_p.offset_from(&raw mut vissprites as *mut vissprite_t) as ::core::ffi::c_long
        as ::core::ffi::c_int;
    ...
    vissprites[0 as ::core::ffi::c_int as usize].prev = &raw mut unsorted as *mut vissprite_s;
    unsorted.next = (&raw mut vissprites as *mut vissprite_t)
        .offset(0 as ::core::ffi::c_int as isize) as *mut vissprite_t
        as *mut vissprite_s;
    let ref mut c2rust_fresh0 = (*vissprite_p.offset(-(1 as ::core::ffi::c_int as isize))).next;
    *c2rust_fresh0 = &raw mut unsorted as *mut vissprite_s;
    unsorted.prev = vissprite_p.offset(-(1 as ::core::ffi::c_int as isize)) as *mut vissprite_s;
...
pub unsafe extern "C" fn R_DrawSprite(mut spr: *mut vissprite_t) {
    ...
    x = (*spr).x1;
    while x <= (*spr).x2 {
        cliptop[x as usize] = -2 as ::core::ffi::c_short;
    ...
    while x <= (*spr).x2 {
        ...
        if cliptop[x as usize] as ::core::ffi::c_int == -2 as ::core::ffi::c_int {
            cliptop[x as usize] = -1 as ::core::ffi::c_short;
        }
        x += 1;
    }
