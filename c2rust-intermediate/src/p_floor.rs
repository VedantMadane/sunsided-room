extern "C" {
    ...
    fn twoSided(sector: ::core::ffi::c_int, line: ::core::ffi::c_int) -> ::core::ffi::c_int;
    fn getSector(
    ...
    if res as ::core::ffi::c_uint == pastdest as ::core::ffi::c_int as ::core::ffi::c_uint {
        ...
        if (*floor).direction == 1 as ::core::ffi::c_int {
            match (*floor).type_0 as ::core::ffi::c_uint {
                11 => {
                    (*(*floor).sector).special = (*floor).newspecial as ::core::ffi::c_short;
        ...
        's_391: {
            match floortype as ::core::ffi::c_uint {
                ...
                12 => {
                    ...
                    (*floor).floordestheight = ((*(*floor).sector).floorheight
                        as ::core::ffi::c_int
                        + 512 as ::core::ffi::c_int * FRACUNIT)
                        as fixed_t;
                    break 's_391;
                }
                8 => {
                ...
                5 => {
                        ...
                        if twoSided(secnum, i) != 0 {
                                ...
                                >= 0 as ::core::ffi::c_int
                            {
                                if *textureheight.offset((*side).bottomtexture as isize) < minsize {
                                    minsize = *textureheight.offset((*side).bottomtexture as isize)
                                        as ::core::ffi::c_int;
                                }
                            }
                    ...
                    (*floor).floordestheight =
                        ((*(*floor).sector).floorheight as ::core::ffi::c_int + minsize) as fixed_t;
                    break 's_391;
                }
                6 => {
                    (*floor).direction = -1 as ::core::ffi::c_int;
            ...
            (*floor).floordestheight -= 8 as ::core::ffi::c_int
                * FRACUNIT
                * (floortype as ::core::ffi::c_uint
                    == raiseFloorCrush as ::core::ffi::c_int as ::core::ffi::c_uint)
                    as ::core::ffi::c_int;
        }
    }
    return rtn;
...
pub unsafe extern "C" fn EV_BuildStairs(
    ...
    loop {
        ...
        loop {
            ...
            i = 0 as ::core::ffi::c_int;
            while i < (*sec).linecount {
                if !((**(*sec).lines.offset(i as isize)).flags as ::core::ffi::c_int & ML_TWOSIDED
                    == 0)
                {
                    tsec = (**(*sec).lines.offset(i as isize)).frontsector;
                    newsecnum =
                        tsec.offset_from(sectors) as ::core::ffi::c_long as ::core::ffi::c_int;
                    if !(secnum != newsecnum) {
