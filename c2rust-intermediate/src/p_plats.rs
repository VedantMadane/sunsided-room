extern "C" {
    ...
    fn P_FindNextHighestFloor(sec: *mut sector_t, currentheight: ::core::ffi::c_int) -> fixed_t;
...
#[no_mangle]
pub static mut activeplats: [*mut plat_t; 30] = [::core::ptr::null_mut::<plat_t>(); 30];
#[no_mangle]
        ...
        0 => {
            ...
            if (*plat).type_0 as ::core::ffi::c_uint
                ...
                || (*plat).type_0 as ::core::ffi::c_uint
                    == raiseToNearestAndChange as ::core::ffi::c_int as ::core::ffi::c_uint
            {
            ...
            if res as ::core::ffi::c_uint == crushed as ::core::ffi::c_int as ::core::ffi::c_uint
                && (*plat).crush == 0
            {
...
pub unsafe extern "C" fn EV_DoPlat(
    ...
    loop {
        ...
        (*plat).thinker.function.acp1 =
            ::core::mem::transmute::<Option<unsafe extern "C" fn(*mut plat_t) -> ()>, actionf_p1>(
        ...
        match type_0 as ::core::ffi::c_uint {
            3 => {
                ...
                .sector)
                    .floorpic;
                (*plat).high =
                    P_FindNextHighestFloor(sec, (*sec).floorheight as ::core::ffi::c_int);
            ...
            2 => {
                ...
                .sector)
                    .floorpic;
                (*plat).high =
                    ((*sec).floorheight as ::core::ffi::c_int + amount * FRACUNIT) as fixed_t;
                (*plat).wait = 0 as ::core::ffi::c_int;
                (*plat).status = up;
                S_StartSound(
                    &raw mut (*sec).soundorg as *mut ::core::ffi::c_void,
...
pub unsafe extern "C" fn P_ActivateInStasis(mut tag: ::core::ffi::c_int) {
    ...
    while i < MAXPLATS {
        if !activeplats[i as usize].is_null()
            && (*activeplats[i as usize]).tag == tag
...
pub unsafe extern "C" fn EV_StopPlat(mut line: *mut line_t) {
    ...
    while j < MAXPLATS {
            ...
            && (*activeplats[j as usize]).tag == (*line).tag as ::core::ffi::c_int
        {
            ...
            (*activeplats[j as usize]).thinker.function.acv =
                ::core::mem::transmute::<*mut ::core::ffi::c_void, actionf_v>(NULL);
        }
        j += 1;
    }
}
...
pub unsafe extern "C" fn P_AddActivePlat(mut plat: *mut plat_t) {
    ...
    snprintf(
        ...
        b"P_AddActivePlat: no more plats!\0".as_ptr() as *const ::core::ffi::c_char,
    );
...
pub unsafe extern "C" fn P_RemoveActivePlat(mut plat: *mut plat_t) {
    ...
    while i < MAXPLATS {
        if plat == activeplats[i as usize] {
            ...
            P_RemoveThinker(
                &raw mut (**(&raw mut activeplats as *mut *mut plat_t).offset(i as isize)).thinker,
            );
    ...
    snprintf(
        &raw mut _i_err_buf as *mut ::core::ffi::c_char,
        ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
        b"P_RemoveActivePlat: can't find plat!\0".as_ptr() as *const ::core::ffi::c_char,
    );
    I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
}
