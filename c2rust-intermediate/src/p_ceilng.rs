...
#[no_mangle]
pub static mut activeceilings: [*mut ceiling_t; 30] = [::core::ptr::null_mut::<ceiling_t>(); 30];
#[no_mangle]
    ...
    match (*ceiling).direction {
        ...
        -1 => {
                ...
                == crushed as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                match (*ceiling).type_0 as ::core::ffi::c_uint {
                    5 | 3 | 2 => {
                        (*ceiling).speed = (CEILSPEED / 8 as ::core::ffi::c_int) as fixed_t;
                    }
                    _ => {}
                }
            }
...
pub unsafe extern "C" fn EV_DoCeiling(
    ...
    loop {
        ...
        (*ceiling).thinker.function.acp1 = ::core::mem::transmute::<
            ...
            actionf_p1,
        >(Some(
            T_MoveCeiling as unsafe extern "C" fn(*mut ceiling_t) -> (),
        ));
        (*ceiling).sector = sec;
...
pub unsafe extern "C" fn P_RemoveActiveCeiling(mut c: *mut ceiling_t) {
    ...
    while i < MAXCEILINGS {
        if activeceilings[i as usize] == c {
            ...
            P_RemoveThinker(
                &raw mut (**(&raw mut activeceilings as *mut *mut ceiling_t).offset(i as isize))
                    .thinker,
            );
...
pub unsafe extern "C" fn P_ActivateInStasisCeiling(mut line: *mut line_t) {
    ...
    while i < MAXCEILINGS {
        ...
        {
            (*activeceilings[i as usize]).direction = (*activeceilings[i as usize]).olddirection;
...
#[no_mangle]
pub unsafe extern "C" fn EV_CeilingCrushStop(mut line: *mut line_t) -> ::core::ffi::c_int {
    let mut i: ::core::ffi::c_int = 0;
    let mut rtn: ::core::ffi::c_int = 0;
    rtn = 0 as ::core::ffi::c_int;
    i = 0 as ::core::ffi::c_int;
    while i < MAXCEILINGS {
        if !activeceilings[i as usize].is_null()
            ...
            && (*activeceilings[i as usize]).direction != 0 as ::core::ffi::c_int
        {
            (*activeceilings[i as usize]).olddirection = (*activeceilings[i as usize]).direction;
            (*activeceilings[i as usize]).thinker.function.acv =
