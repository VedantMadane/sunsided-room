    ...
    match (*ld).slopetype as ::core::ffi::c_uint {
        0 => {
            p1 = (*tmbox.offset(BOXTOP as ::core::ffi::c_int as isize) > (*(*ld).v1).y)
                as ::core::ffi::c_int;
            p2 = (*tmbox.offset(BOXBOTTOM as ::core::ffi::c_int as isize) > (*(*ld).v1).y)
                as ::core::ffi::c_int;
...
pub unsafe extern "C" fn P_PointOnDivlineSide(
    ...
    if ((*line).dy ^ (*line).dx ^ dx ^ dy) as ::core::ffi::c_uint
        ...
        != 0
    {
        if ((*line).dy ^ dx) as ::core::ffi::c_uint & 0x80000000 as ::core::ffi::c_uint != 0 {
            return 1 as ::core::ffi::c_int;
        }
        return 0 as ::core::ffi::c_int;
    }
...
pub unsafe extern "C" fn P_UnsetThingPosition(mut thing: *mut mobj_t) {
    ...
    if (*thing).flags & MF_NOBLOCKMAP as ::core::ffi::c_int == 0 {
        ...
        if !(*thing).bprev.is_null() {
            ...
            if blockx >= 0 as ::core::ffi::c_int
                && blockx < bmapwidth
                && blocky >= 0 as ::core::ffi::c_int
                && blocky < bmapheight
            {
                let ref mut c2rust_fresh1 =
                    *blocklinks.offset((blocky * bmapwidth + blockx) as isize);
                *c2rust_fresh1 = (*thing).bnext as *mut mobj_t;
            }
        }
    }
}
...
pub unsafe extern "C" fn P_BlockLinesIterator(
    ...
    let mut list: *mut ::core::ffi::c_short = ::core::ptr::null_mut::<::core::ffi::c_short>();
...
pub static mut intercepts: [intercept_t; 189] = [intercept_t {
    ...
    isaline: 0,
    d: C2Rust_Unnamed_1 {
        thing: ::core::ptr::null_mut::<mobj_t>(),
    },
}; 189];
#[no_mangle]
pub static mut intercept_p: *mut intercept_t = ::core::ptr::null_mut::<intercept_t>();
#[no_mangle]
...
pub unsafe extern "C" fn PIT_AddLineIntercepts(mut ld: *mut line_t) -> boolean {
    ...
    InterceptsOverrun(
        intercept_p.offset_from(&raw mut intercepts as *mut intercept_t) as ::core::ffi::c_long
            as ::core::ffi::c_int,
        intercept_p,
    );
...
pub unsafe extern "C" fn PIT_AddThingIntercepts(mut thing: *mut mobj_t) -> boolean {
    ...
    let mut frac: fixed_t = 0;
    tracepositive =
        (trace.dx ^ trace.dy > 0 as ::core::ffi::c_int) as ::core::ffi::c_int as boolean;
    if tracepositive != 0 {
...
pub unsafe extern "C" fn P_TraverseIntercepts(
    ...
    count = intercept_p.offset_from(&raw mut intercepts as *mut intercept_t) as ::core::ffi::c_long
        as ::core::ffi::c_int;
...
static mut intercepts_overrun: [intercepts_overrun_t; 23] = unsafe {
    [
        ...
        intercepts_overrun_t {
            len: 4 as ::core::ffi::c_int,
            addr: &raw const bmapwidth as *mut ::core::ffi::c_int as *mut ::core::ffi::c_void,
            int16_array: false_0 as boolean,
        },
        intercepts_overrun_t {
            len: 4 as ::core::ffi::c_int,
        ...
        intercepts_overrun_t {
            len: 4 as ::core::ffi::c_int,
            addr: &raw const bmapheight as *mut ::core::ffi::c_int as *mut ::core::ffi::c_void,
            int16_array: false_0 as boolean,
        },
        intercepts_overrun_t {
        ...
        if offset + intercepts_overrun[i as usize].len > location {
            ...
            if !addr.is_null() {
                if intercepts_overrun[i as usize].int16_array != 0 {
                    ...
                    *(addr as *mut ::core::ffi::c_short).offset(index as isize) =
                        (value & 0xffff as ::core::ffi::c_int) as ::core::ffi::c_short;
                    *(addr as *mut ::core::ffi::c_short)
                        .offset((index + 1 as ::core::ffi::c_int) as isize) =
                        (value >> 16 as ::core::ffi::c_int & 0xffff as ::core::ffi::c_int)
                            as ::core::ffi::c_short;
                } else {
...
pub unsafe extern "C" fn P_PathTraverse(
    ...
    if x1 as ::core::ffi::c_int - bmaporgx as ::core::ffi::c_int
        & MAPBLOCKSIZE - 1 as ::core::ffi::c_int
        == 0 as ::core::ffi::c_int
    {
        x1 += FRACUNIT;
    }
    ...
    if xt2 > xt1 {
        ...
        partial = (FRACUNIT
            - (x1 as ::core::ffi::c_int >> MAPBTOFRAC & FRACUNIT - 1 as ::core::ffi::c_int))
            as fixed_t;
        ystep = FixedDiv(
            y2 - y1,
        ...
        mapxstep = -1 as ::core::ffi::c_int;
        partial = (x1 as ::core::ffi::c_int >> MAPBTOFRAC & FRACUNIT - 1 as ::core::ffi::c_int)
            as fixed_t;
        ystep = FixedDiv(
            y2 - y1,
            abs(x2 as ::core::ffi::c_int - x1 as ::core::ffi::c_int) as fixed_t,
    ...
    if yt2 > yt1 {
        ...
        partial = (FRACUNIT
            - (y1 as ::core::ffi::c_int >> MAPBTOFRAC & FRACUNIT - 1 as ::core::ffi::c_int))
            as fixed_t;
        xstep = FixedDiv(
            x2 - x1,
        ...
        mapystep = -1 as ::core::ffi::c_int;
        partial = (y1 as ::core::ffi::c_int >> MAPBTOFRAC & FRACUNIT - 1 as ::core::ffi::c_int)
            as fixed_t;
        xstep = FixedDiv(
            x2 - x1,
            abs(y2 as ::core::ffi::c_int - y1 as ::core::ffi::c_int) as fixed_t,
