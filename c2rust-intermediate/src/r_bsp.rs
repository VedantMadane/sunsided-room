...
#[no_mangle]
pub static mut curline: *mut seg_t = ::core::ptr::null_mut::<seg_t>();
#[no_mangle]
pub static mut sidedef: *mut side_t = ::core::ptr::null_mut::<side_t>();
#[no_mangle]
pub static mut linedef: *mut line_t = ::core::ptr::null_mut::<line_t>();
#[no_mangle]
pub static mut frontsector: *mut sector_t = ::core::ptr::null_mut::<sector_t>();
#[no_mangle]
pub static mut backsector: *mut sector_t = ::core::ptr::null_mut::<sector_t>();
#[no_mangle]
pub static mut drawsegs: [drawseg_t; 256] = [drawseg_t {
    curline: ::core::ptr::null_mut::<seg_t>(),
    x1: 0,
    x2: 0,
    scale1: 0,
    scale2: 0,
    ...
    bsilheight: 0,
    tsilheight: 0,
    sprtopclip: ::core::ptr::null_mut::<::core::ffi::c_short>(),
    sprbottomclip: ::core::ptr::null_mut::<::core::ffi::c_short>(),
    maskedtexturecol: ::core::ptr::null_mut::<::core::ffi::c_short>(),
}; 256];
#[no_mangle]
pub static mut ds_p: *mut drawseg_t = ::core::ptr::null_mut::<drawseg_t>();
#[no_mangle]
pub unsafe extern "C" fn R_ClearDrawSegs() {
    ds_p = &raw mut drawsegs as *mut drawseg_t;
}
#[no_mangle]
pub static mut newend: *mut cliprange_t = ::core::ptr::null_mut::<cliprange_t>();
#[no_mangle]
...
pub unsafe extern "C" fn R_ClipSolidWallSegment(
    ...
    '_crunch: {
        while last
            >= (*next.offset(1 as ::core::ffi::c_int as isize)).first - 1 as ::core::ffi::c_int
        {
            R_StoreWallRange(
...
pub unsafe extern "C" fn R_ClipPassWallSegment(
    ...
    while last >= (*start.offset(1 as ::core::ffi::c_int as isize)).first - 1 as ::core::ffi::c_int
    {
        R_StoreWallRange(
            (*start).last + 1 as ::core::ffi::c_int,
            (*start.offset(1 as ::core::ffi::c_int as isize)).first - 1 as ::core::ffi::c_int,
        );
        start = start.offset(1);
        if last <= (*start).last {
            return;
...
pub unsafe extern "C" fn R_ClearClipSegs() {
    solidsegs[0 as ::core::ffi::c_int as usize].first = -0x7fffffff as ::core::ffi::c_int;
    ...
    newend = (&raw mut solidsegs as *mut cliprange_t).offset(2 as ::core::ffi::c_int as isize);
}
#[no_mangle]
...
pub unsafe extern "C" fn R_CheckBBox(mut bspcoord: *mut fixed_t) -> boolean {
    ...
    x1 = *bspcoord.offset(checkcoord[boxpos as usize][0 as ::core::ffi::c_int as usize] as isize);
    y1 = *bspcoord.offset(checkcoord[boxpos as usize][1 as ::core::ffi::c_int as usize] as isize);
    x2 = *bspcoord.offset(checkcoord[boxpos as usize][2 as ::core::ffi::c_int as usize] as isize);
    y2 = *bspcoord.offset(checkcoord[boxpos as usize][3 as ::core::ffi::c_int as usize] as isize);
...
pub unsafe extern "C" fn R_Subsector(mut num: ::core::ffi::c_int) {
    ...
    if num >= numsubsectors {
        ...
        snprintf(
            ...
            b"R_Subsector: ss %i with numss = %i\0".as_ptr() as *const ::core::ffi::c_char,
            num,
            numsubsectors,
        );
