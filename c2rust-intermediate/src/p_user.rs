...
pub unsafe extern "C" fn P_CalcHeight(mut player: *mut player_t) {
    ...
    if (*player).cheats & CF_NOMOMENTUM as ::core::ffi::c_int != 0 || onground == 0 {
        (*player).viewz = ((*(*player).mo).z as ::core::ffi::c_int + VIEWHEIGHT) as fixed_t;
        if (*player).viewz
            > (*(*player).mo).ceilingz as ::core::ffi::c_int - 4 as ::core::ffi::c_int * FRACUNIT
        {
...
pub unsafe extern "C" fn P_MovePlayer(mut player: *mut player_t) {
    ...
    (*(*player).mo).angle = (*(*player).mo).angle.wrapping_add(
        (((*cmd).angleturn as ::core::ffi::c_int) << 16 as ::core::ffi::c_int) as angle_t,
    );
    onground = ((*(*player).mo).z <= (*(*player).mo).floorz) as ::core::ffi::c_int as boolean;
    ...
    if ((*cmd).forwardmove as ::core::ffi::c_int != 0 || (*cmd).sidemove as ::core::ffi::c_int != 0)
        && (*(*player).mo).state
            == (&raw mut states as *mut state_t).offset(S_PLAY as ::core::ffi::c_int as isize)
                as *mut state_t
    {
...
pub unsafe extern "C" fn P_PlayerThink(mut player: *mut player_t) {
    ...
    if (*(*player).mo).flags & MF_JUSTATTACKED as ::core::ffi::c_int != 0 {
        ...
        (*cmd).forwardmove =
            (0xc800 as ::core::ffi::c_int / 512 as ::core::ffi::c_int) as ::core::ffi::c_schar;
    ...
    if (*cmd).buttons as ::core::ffi::c_int & BT_CHANGE as ::core::ffi::c_int != 0 {
        newweapon = (((*cmd).buttons as ::core::ffi::c_int & BT_WEAPONMASK as ::core::ffi::c_int)
            >> BT_WEAPONSHIFT as ::core::ffi::c_int) as weapontype_t;
        if newweapon as ::core::ffi::c_uint == wp_fist as ::core::ffi::c_int as ::core::ffi::c_uint
        ...
        if (*player).weaponowned[newweapon as usize] != 0
            && newweapon as ::core::ffi::c_uint != (*player).readyweapon as ::core::ffi::c_uint
        {
