...
pub const SNDDEVICE_CD: C2Rust_Unnamed = 10;
pub const SNDDEVICE_AWE32: C2Rust_Unnamed = 9;
pub const SNDDEVICE_GENMIDI: C2Rust_Unnamed = 8;
pub const SNDDEVICE_SOUNDCANVAS: C2Rust_Unnamed = 7;
pub const SNDDEVICE_WAVEBLASTER: C2Rust_Unnamed = 6;
pub const SNDDEVICE_GUS: C2Rust_Unnamed = 5;
pub const SNDDEVICE_PAS: C2Rust_Unnamed = 4;
pub const SNDDEVICE_SB: C2Rust_Unnamed = 3;
pub const SNDDEVICE_ADLIB: C2Rust_Unnamed = 2;
pub const SNDDEVICE_PCSPEAKER: C2Rust_Unnamed = 1;
pub const SNDDEVICE_NONE: C2Rust_Unnamed = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ticcmd_t {
...
static mut channels: *mut channel_t = ::core::ptr::null_mut::<channel_t>();
#[no_mangle]
...
static mut mus_playing: *mut musicinfo_t = ::core::ptr::null_mut::<musicinfo_t>();
#[no_mangle]
...
pub unsafe extern "C" fn S_Init(
    ...
    I_PrecacheSounds(
        &raw mut S_sfx as *mut sfxinfo_t,
        NUMSFX as ::core::ffi::c_int,
    );
    S_SetSfxVolume(sfxVolume_0);
    S_SetMusicVolume(musicVolume_0);
    channels = Z_Malloc(
        (snd_channels as usize).wrapping_mul(::core::mem::size_of::<channel_t>() as usize)
            as ::core::ffi::c_int,
    ...
    while i < snd_channels {
        let ref mut c2rust_fresh0 = (*channels.offset(i as isize)).sfxinfo;
        *c2rust_fresh0 = ::core::ptr::null_mut::<sfxinfo_t>();
        i += 1;
    }
    ...
    while i < NUMSFX as ::core::ffi::c_int {
        let ref mut c2rust_fresh1 =
            (*(&raw mut S_sfx as *mut sfxinfo_t).offset(i as isize)).usefulness;
        *c2rust_fresh1 = -1 as ::core::ffi::c_int;
        (*(&raw mut S_sfx as *mut sfxinfo_t).offset(i as isize)).lumpnum = *c2rust_fresh1;
        i += 1;
    }
    I_AtExit(
        Some(S_Shutdown as unsafe extern "C" fn() -> ()),
        true_0 as boolean,
    );
}
#[no_mangle]
...
unsafe extern "C" fn S_AdjustSoundParams(
    ...
    adx = abs((*listener).x as ::core::ffi::c_int - (*source).x as ::core::ffi::c_int) as fixed_t;
    ady = abs((*listener).y as ::core::ffi::c_int - (*source).y as ::core::ffi::c_int) as fixed_t;
    approx_dist = adx + ady - ((if adx < ady { adx } else { ady }) >> 1 as ::core::ffi::c_int);
    ...
    *sep = (128 as fixed_t - (FixedMul(S_STEREO_SWING, finesine[angle as usize]) >> FRACBITS))
    ...
    if approx_dist < S_CLOSE_DIST {
        ...
        *vol = snd_SfxVolume * (S_CLIPPING_DIST - approx_dist as ::core::ffi::c_int >> FRACBITS)
            / S_ATTENUATOR;
    }
...
pub unsafe extern "C" fn S_StartSound(
    ...
    if sfx_id < 1 as ::core::ffi::c_int || sfx_id > NUMSFX as ::core::ffi::c_int {
        ...
        snprintf(
            ...
            b"Bad sfx #: %d\0".as_ptr() as *const ::core::ffi::c_char,
            sfx_id,
        );
    ...
    let c2rust_fresh2 = (*sfx).usefulness;
...
pub unsafe extern "C" fn S_SetMusicVolume(mut volume: ::core::ffi::c_int) {
    if volume < 0 as ::core::ffi::c_int || volume > 127 as ::core::ffi::c_int {
        ...
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"Attempt to set music volume at %d\0".as_ptr() as *const ::core::ffi::c_char,
            volume,
        );
        I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
    }
...
pub unsafe extern "C" fn S_SetSfxVolume(mut volume: ::core::ffi::c_int) {
    if volume < 0 as ::core::ffi::c_int || volume > 127 as ::core::ffi::c_int {
        ...
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"Attempt to set sfx volume at %d\0".as_ptr() as *const ::core::ffi::c_char,
            volume,
        );
        I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
    }
...
pub unsafe extern "C" fn S_ChangeMusic(
    ...
    if musicnum <= mus_None as ::core::ffi::c_int || musicnum >= NUMMUSIC as ::core::ffi::c_int {
        let mut _i_err_buf: [::core::ffi::c_char; 512] = [0; 512];
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"Bad music number %d\0".as_ptr() as *const ::core::ffi::c_char,
            musicnum,
        );
        I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
    } else {
        music =
            (&raw mut S_music as *mut musicinfo_t).offset(musicnum as isize) as *mut musicinfo_t;
    }
    ...
    if (*music).lumpnum == 0 {
        M_snprintf_clamp(
            ...
            snprintf(
                &raw mut namebuf as *mut ::core::ffi::c_char,
                ::core::mem::size_of::<[::core::ffi::c_char; 9]>() as size_t,
                b"d_%s\0".as_ptr() as *const ::core::ffi::c_char,
                (*music).name,
            ),
        );
