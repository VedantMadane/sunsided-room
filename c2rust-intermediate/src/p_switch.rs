...
pub static mut buttonlist: [button_t; 16] = [button_t {
    line: ::core::ptr::null_mut::<line_t>(),
    where_0: top,
    btexture: 0,
    btimer: 0,
    soundorg: ::core::ptr::null_mut::<degenmobj_t>(),
}; 16];
#[no_mangle]
    ...
    while i < MAXSWITCHES {
        if alphSwitchList[i as usize].episode == 0 {
            ...
            if alphSwitchList[i as usize].episode as ::core::ffi::c_int <= episode {
                let c2rust_fresh0 = index;
                index = index + 1;
                switchlist[c2rust_fresh0 as usize] = R_TextureNumForName(
                    &raw mut (*(&raw mut alphSwitchList as *mut switchlist_t).offset(i as isize))
                        .name1 as *mut ::core::ffi::c_char,
                );
                let c2rust_fresh1 = index;
                index = index + 1;
                switchlist[c2rust_fresh1 as usize] = R_TextureNumForName(
                    &raw mut (*(&raw mut alphSwitchList as *mut switchlist_t).offset(i as isize))
...
pub unsafe extern "C" fn P_StartButton(
    ...
    snprintf(
        ...
        b"P_StartButton: no button slots left!\0".as_ptr() as *const ::core::ffi::c_char,
    );
...
pub unsafe extern "C" fn P_ChangeSwitchTexture(
    ...
    texTop = (*sides.offset((*line).sidenum[0 as ::core::ffi::c_int as usize] as isize)).toptexture
        as ::core::ffi::c_int;
    texMid = (*sides.offset((*line).sidenum[0 as ::core::ffi::c_int as usize] as isize)).midtexture
        as ::core::ffi::c_int;
    ...
    while i < numswitches * 2 as ::core::ffi::c_int {
        if switchlist[i as usize] == texTop {
            S_StartSound(
                (*(&raw mut buttonlist as *mut button_t)).soundorg as *mut ::core::ffi::c_void,
                sound,
            );
            (*sides.offset((*line).sidenum[0 as ::core::ffi::c_int as usize] as isize))
                .toptexture =
                switchlist[(i ^ 1 as ::core::ffi::c_int) as usize] as ::core::ffi::c_short;
            if useAgain != 0 {
