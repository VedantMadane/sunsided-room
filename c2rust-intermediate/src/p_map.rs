extern "C" {
    ...
    fn P_PointOnLineSide(x: fixed_t, y: fixed_t, line: *mut line_t) -> ::core::ffi::c_int;
...
pub const MF_TRANSSHIFT: C2Rust_Unnamed_0 = 26;
pub const MF_TRANSLATION: C2Rust_Unnamed_0 = 201326592;
pub const MF_NOTDMATCH: C2Rust_Unnamed_0 = 33554432;
pub const MF_SKULLFLY: C2Rust_Unnamed_0 = 16777216;
pub const MF_COUNTITEM: C2Rust_Unnamed_0 = 8388608;
pub const MF_COUNTKILL: C2Rust_Unnamed_0 = 4194304;
pub const MF_INFLOAT: C2Rust_Unnamed_0 = 2097152;
pub const MF_CORPSE: C2Rust_Unnamed_0 = 1048576;
pub const MF_NOBLOOD: C2Rust_Unnamed_0 = 524288;
pub const MF_SHADOW: C2Rust_Unnamed_0 = 262144;
pub const MF_DROPPED: C2Rust_Unnamed_0 = 131072;
pub const MF_MISSILE: C2Rust_Unnamed_0 = 65536;
pub const MF_TELEPORT: C2Rust_Unnamed_0 = 32768;
pub const MF_FLOAT: C2Rust_Unnamed_0 = 16384;
pub const MF_SLIDE: C2Rust_Unnamed_0 = 8192;
pub const MF_NOCLIP: C2Rust_Unnamed_0 = 4096;
pub const MF_PICKUP: C2Rust_Unnamed_0 = 2048;
pub const MF_DROPOFF: C2Rust_Unnamed_0 = 1024;
pub const MF_NOGRAVITY: C2Rust_Unnamed_0 = 512;
pub const MF_SPAWNCEILING: C2Rust_Unnamed_0 = 256;
pub const MF_JUSTATTACKED: C2Rust_Unnamed_0 = 128;
pub const MF_JUSTHIT: C2Rust_Unnamed_0 = 64;
pub const MF_AMBUSH: C2Rust_Unnamed_0 = 32;
pub const MF_NOBLOCKMAP: C2Rust_Unnamed_0 = 16;
pub const MF_NOSECTOR: C2Rust_Unnamed_0 = 8;
pub const MF_SHOOTABLE: C2Rust_Unnamed_0 = 4;
pub const MF_SOLID: C2Rust_Unnamed_0 = 2;
pub const MF_SPECIAL: C2Rust_Unnamed_0 = 1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct mobj_s {
...
#[no_mangle]
pub static mut tmthing: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
...
#[no_mangle]
pub static mut ceilingline: *mut line_t = ::core::ptr::null_mut::<line_t>();
#[no_mangle]
pub static mut spechit: [*mut line_t; 20] = [::core::ptr::null_mut::<line_t>(); 20];
#[no_mangle]
...
pub unsafe extern "C" fn P_TeleportMove(
    ...
    xl = tmbbox[BOXLEFT as ::core::ffi::c_int as usize] as ::core::ffi::c_int
        - bmaporgx as ::core::ffi::c_int
        - 32 as ::core::ffi::c_int * FRACUNIT
        >> MAPBLOCKSHIFT;
    xh = tmbbox[BOXRIGHT as ::core::ffi::c_int as usize] as ::core::ffi::c_int
        - bmaporgx as ::core::ffi::c_int
        + 32 as ::core::ffi::c_int * FRACUNIT
        >> MAPBLOCKSHIFT;
    yl = tmbbox[BOXBOTTOM as ::core::ffi::c_int as usize] as ::core::ffi::c_int
        - bmaporgy as ::core::ffi::c_int
        - 32 as ::core::ffi::c_int * FRACUNIT
        >> MAPBLOCKSHIFT;
    yh = tmbbox[BOXTOP as ::core::ffi::c_int as usize] as ::core::ffi::c_int
        - bmaporgy as ::core::ffi::c_int
        + 32 as ::core::ffi::c_int * FRACUNIT
        >> MAPBLOCKSHIFT;
    bx = xl;
...
pub unsafe extern "C" fn PIT_CheckLine(mut ld: *mut line_t) -> boolean {
    ...
    if (*tmthing).flags & MF_MISSILE as ::core::ffi::c_int == 0 {
        ...
        if (*tmthing).player.is_null() && (*ld).flags as ::core::ffi::c_int & ML_BLOCKMONSTERS != 0
        {
            return false_0 as boolean;
        }
    }
...
pub unsafe extern "C" fn PIT_CheckThing(mut thing: *mut mobj_t) -> boolean {
    ...
    if (*thing).flags
        & (MF_SOLID as ::core::ffi::c_int
            | MF_SPECIAL as ::core::ffi::c_int
            | MF_SHOOTABLE as ::core::ffi::c_int)
        == 0
    {
        return true_0 as boolean;
    }
    ...
    return ((*thing).flags & MF_SOLID as ::core::ffi::c_int == 0) as ::core::ffi::c_int as boolean;
}
#[no_mangle]
...
pub unsafe extern "C" fn P_TryMove(
    ...
    if (*thing).flags & MF_NOCLIP as ::core::ffi::c_int == 0 {
        ...
        if (*thing).flags & (MF_DROPOFF as ::core::ffi::c_int | MF_FLOAT as ::core::ffi::c_int) == 0
    ...
    (*thing).y = y;
    P_SetThingPosition(thing);
    if (*thing).flags & (MF_TELEPORT as ::core::ffi::c_int | MF_NOCLIP as ::core::ffi::c_int) == 0 {
        loop {
            ...
            if side != oldside {
                if (*ld).special != 0 {
                    P_CrossSpecialLine(
                        ld.offset_from(lines) as ::core::ffi::c_long as ::core::ffi::c_int,
                        oldside,
                        thing,
                    );
                }
...
#[no_mangle]
pub static mut bestslideline: *mut line_t = ::core::ptr::null_mut::<line_t>();
#[no_mangle]
pub static mut secondslideline: *mut line_t = ::core::ptr::null_mut::<line_t>();
#[no_mangle]
pub static mut slidemo: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
...
pub unsafe extern "C" fn PTR_SlideTraverse(mut in_0: *mut intercept_t) -> boolean {
    ...
    if (*in_0).isaline == 0 {
        ...
        snprintf(
            ...
            b"PTR_SlideTraverse: not a line?\0".as_ptr() as *const ::core::ffi::c_char,
        );
...
#[no_mangle]
pub static mut linetarget: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
pub static mut shootthing: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
...
pub unsafe extern "C" fn PTR_AimTraverse(mut in_0: *mut intercept_t) -> boolean {
    ...
    aimslope = ((thingtopslope as ::core::ffi::c_int + thingbottomslope as ::core::ffi::c_int)
        / 2 as ::core::ffi::c_int) as fixed_t;
    linetarget = th;
    return false_0 as boolean;
}
#[no_mangle]
...
pub unsafe extern "C" fn P_AimLineAttack(
    ...
    topslope = (100 as ::core::ffi::c_int * FRACUNIT / 160 as ::core::ffi::c_int) as fixed_t;
    bottomslope = (-100 as ::core::ffi::c_int * FRACUNIT / 160 as ::core::ffi::c_int) as fixed_t;
...
#[no_mangle]
pub static mut usething: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
pub unsafe extern "C" fn PTR_UseTraverse(mut in_0: *mut intercept_t) -> boolean {
    ...
    if P_PointOnLineSide((*usething).x, (*usething).y, (*in_0).d.line) == 1 as ::core::ffi::c_int {
...
#[no_mangle]
pub static mut bombsource: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
pub static mut bombspot: *mut mobj_t = ::core::ptr::null_mut::<mobj_t>();
#[no_mangle]
...
pub unsafe extern "C" fn PIT_RadiusAttack(mut thing: *mut mobj_t) -> boolean {
    ...
    dx = abs((*thing).x as ::core::ffi::c_int - (*bombspot).x as ::core::ffi::c_int) as fixed_t;
    dy = abs((*thing).y as ::core::ffi::c_int - (*bombspot).y as ::core::ffi::c_int) as fixed_t;
...
unsafe extern "C" fn SpechitOverrun(mut ld: *mut line_t) {
    ...
    if baseaddr == 0 as ::core::ffi::c_uint {
        ...
        p = M_CheckParmWithArgs(
            b"-spechit\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
            1 as ::core::ffi::c_int,
        );
