extern "C" {
    ...
    fn P_FindSectorFromLineTag(line: *mut line_t, start: ::core::ffi::c_int) -> ::core::ffi::c_int;
...
pub unsafe extern "C" fn T_VerticalDoor(mut door: *mut vldoor_t) {
    ...
    match (*door).direction {
        ...
        -1 => {
            ...
            if res as ::core::ffi::c_uint == pastdest as ::core::ffi::c_int as ::core::ffi::c_uint {
                match (*door).type_0 as ::core::ffi::c_uint {
                    5 | 7 => {
...
pub unsafe extern "C" fn EV_DoLockedDoor(
    ...
    match (*line).special as ::core::ffi::c_int {
        99 | 133 => {
            ...
            {
                (*p).message = b"You need a blue key to activate this object\0".as_ptr()
        ...
        134 | 135 => {
            ...
            {
                (*p).message = b"You need a red key to activate this object\0".as_ptr()
                    as *const ::core::ffi::c_char
                    as *mut ::core::ffi::c_char;
                S_StartSound(NULL, sfx_oof as ::core::ffi::c_int);
                return 0 as ::core::ffi::c_int;
        ...
        136 | 137 => {
            ...
            {
                (*p).message = b"You need a yellow key to activate this object\0".as_ptr()
                    as *const ::core::ffi::c_char
                    as *mut ::core::ffi::c_char;
                S_StartSound(NULL, sfx_oof as ::core::ffi::c_int);
                return 0 as ::core::ffi::c_int;
    ...
    loop {
        ...
        match type_0 as ::core::ffi::c_uint {
            7 => {
                ...
                (*door).direction = -1 as ::core::ffi::c_int;
                (*door).speed =
                    (FRACUNIT * 2 as ::core::ffi::c_int * 4 as ::core::ffi::c_int) as fixed_t;
                S_StartSound(
                    &raw mut (*(*door).sector).soundorg as *mut ::core::ffi::c_void,
                    sfx_bdcls as ::core::ffi::c_int,
                );
...
pub unsafe extern "C" fn EV_VerticalDoor(mut line: *mut line_t, mut thing: *mut mobj_t) {
    ...
    match (*line).special as ::core::ffi::c_int {
        26 | 32 => {
            ...
            {
                (*player).message = b"You need a blue key to open this door\0".as_ptr()
                    as *const ::core::ffi::c_char
                    as *mut ::core::ffi::c_char;
                S_StartSound(NULL, sfx_oof as ::core::ffi::c_int);
                return;
        ...
        27 | 34 => {
            ...
            {
                (*player).message = b"You need a yellow key to open this door\0".as_ptr()
                    as *const ::core::ffi::c_char
                    as *mut ::core::ffi::c_char;
                S_StartSound(NULL, sfx_oof as ::core::ffi::c_int);
                return;
        ...
        28 | 33 => {
            ...
            {
                (*player).message = b"You need a red key to open this door\0".as_ptr()
                    as *const ::core::ffi::c_char
                    as *mut ::core::ffi::c_char;
                S_StartSound(NULL, sfx_oof as ::core::ffi::c_int);
                return;
    ...
    sec =
        (*sides.offset((*line).sidenum[(side ^ 1 as ::core::ffi::c_int) as usize] as isize)).sector;
    if !(*sec).specialdata.is_null() {
                ...
                if (*door).direction == -1 as ::core::ffi::c_int {
                        ...
                        ))
                    {
                        ...
                        == ::core::mem::transmute::<
                            ...
                            actionf_p1,
                        >(Some(
                            T_PlatRaise as unsafe extern "C" fn(*mut plat_t) -> (),
                        ))
                    {
    ...
    (*door).thinker.function.acp1 =
        ::core::mem::transmute::<Option<unsafe extern "C" fn(*mut vldoor_t) -> ()>, actionf_p1>(
