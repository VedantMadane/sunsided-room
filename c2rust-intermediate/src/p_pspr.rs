...
pub const NUMPSPRITES: C2Rust_Unnamed_2 = 2;
pub const ps_flash: C2Rust_Unnamed_2 = 1;
pub const ps_weapon: C2Rust_Unnamed_2 = 0;
    ...
    loop {
        if stnum as u64 == 0 {
            ...
            if (*state).action.acp2.is_some() {
                (*state).action.acp2.expect("non-null function pointer")(
...
pub unsafe extern "C" fn P_CalcSwing(mut player: *mut player_t) {
    ...
    angle = FINEANGLES / 70 as ::core::ffi::c_int * leveltime
        + FINEANGLES / 2 as ::core::ffi::c_int
        & FINEMASK;
...
pub unsafe extern "C" fn P_BringUpWeapon(mut player: *mut player_t) {
    ...
    (*player).psprites[ps_weapon as ::core::ffi::c_int as usize].sy =
        (128 as ::core::ffi::c_int * FRACUNIT) as fixed_t;
...
pub unsafe extern "C" fn P_CheckAmmo(mut player: *mut player_t) -> boolean {
    ...
    loop {
        ...
        } else if (*player).weaponowned[wp_supershotgun as ::core::ffi::c_int as usize] != 0
            && (*player).ammo[am_shell as ::core::ffi::c_int as usize] > 2 as ::core::ffi::c_int
            && gamemode as ::core::ffi::c_uint
            ...
            && (*player).ammo[am_misl as ::core::ffi::c_int as usize] != 0
        {
            ...
            && (*player).ammo[am_cell as ::core::ffi::c_int as usize] > 40 as ::core::ffi::c_int
            && gamemode as ::core::ffi::c_uint
                != shareware as ::core::ffi::c_int as ::core::ffi::c_uint
        {
...
pub unsafe extern "C" fn A_WeaponReady(mut player: *mut player_t, mut psp: *mut pspdef_t) {
    ...
    let mut angle: ::core::ffi::c_int = 0;
    if (*(*player).mo).state
        == (&raw mut states as *mut state_t).offset(S_PLAY_ATK1 as ::core::ffi::c_int as isize)
            as *mut state_t
        || (*(*player).mo).state
            == (&raw mut states as *mut state_t).offset(S_PLAY_ATK2 as ::core::ffi::c_int as isize)
                as *mut state_t
    {
    ...
    if (*player).readyweapon as ::core::ffi::c_uint
        == wp_chainsaw as ::core::ffi::c_int as ::core::ffi::c_uint
        && (*psp).state
            == (&raw mut states as *mut state_t).offset(S_SAW as ::core::ffi::c_int as isize)
                as *mut state_t
    {
        S_StartSound(
            (*player).mo as *mut ::core::ffi::c_void,
...
pub unsafe extern "C" fn A_Punch(mut player: *mut player_t, mut psp: *mut pspdef_t) {
    ...
    angle = angle.wrapping_add((P_Random() - P_Random() << 18 as ::core::ffi::c_int) as angle_t);
...
pub unsafe extern "C" fn A_Saw(mut player: *mut player_t, mut psp: *mut pspdef_t) {
    ...
    let mut slope: ::core::ffi::c_int = 0;
    damage =
        2 as ::core::ffi::c_int * (P_Random() % 10 as ::core::ffi::c_int + 1 as ::core::ffi::c_int);
    angle = (*(*player).mo).angle;
    angle = angle.wrapping_add((P_Random() - P_Random() << 18 as ::core::ffi::c_int) as angle_t);
    slope = P_AimLineAttack((*player).mo, angle, MELEERANGE + 1 as fixed_t) as ::core::ffi::c_int;
    P_LineAttack(
        (*player).mo,
        angle,
    ...
    if angle.wrapping_sub((*(*player).mo).angle) > ANG180 {
        ...
        {
            (*(*player).mo).angle =
                angle.wrapping_add((ANG90 / 21 as ::core::ffi::c_int) as angle_t);
        } else {
    ...
    {
        (*(*player).mo).angle = angle.wrapping_sub((ANG90 / 21 as ::core::ffi::c_int) as angle_t);
    } else {
        (*(*player).mo).angle = (*(*player).mo)
            .angle
...
pub unsafe extern "C" fn P_GunShot(mut mo: *mut mobj_t, mut accurate: boolean) {
    ...
    let mut damage: ::core::ffi::c_int = 0;
    damage =
        5 as ::core::ffi::c_int * (P_Random() % 3 as ::core::ffi::c_int + 1 as ::core::ffi::c_int);
    angle = (*mo).angle;
    if accurate == 0 {
        angle =
            angle.wrapping_add((P_Random() - P_Random() << 18 as ::core::ffi::c_int) as angle_t);
    }
...
pub unsafe extern "C" fn A_FirePistol(mut player: *mut player_t, mut psp: *mut pspdef_t) {
    ...
    P_GunShot(
        (*player).mo,
        ((*player).refire == 0) as ::core::ffi::c_int as boolean,
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn A_FireShotgun2(mut player: *mut player_t, mut psp: *mut pspdef_t) {
    ...
    while i < 20 as ::core::ffi::c_int {
        ...
        angle = (*(*player).mo).angle;
        angle =
            angle.wrapping_add((P_Random() - P_Random() << 19 as ::core::ffi::c_int) as angle_t);
        P_LineAttack(
            (*player).mo,
            angle,
            MISSILERANGE,
            bulletslope
                + ((P_Random() as fixed_t - P_Random() as fixed_t) << 5 as ::core::ffi::c_int),
            damage,
        );
        i += 1;
    }
...
pub unsafe extern "C" fn A_FireCGun(mut player: *mut player_t, mut psp: *mut pspdef_t) {
    ...
    P_SetPsprite(
        ...
        (*psp)
            ...
            .offset_from(
                (&raw mut states as *mut state_t).offset(S_CHAIN1 as ::core::ffi::c_int as isize)
                    as *mut state_t,
    ...
    while i < 40 as ::core::ffi::c_int {
        ...
        if !linetarget.is_null() {
            ...
            while j < 15 as ::core::ffi::c_int {
                damage += (P_Random() & 7 as ::core::ffi::c_int) + 1 as ::core::ffi::c_int;
                j += 1;
            }
            P_DamageMobj(
                linetarget,
...
pub unsafe extern "C" fn P_MovePsprites(mut player: *mut player_t) {
    ...
    let mut psp: *mut pspdef_t = ::core::ptr::null_mut::<pspdef_t>();
    let mut state: *mut state_t = ::core::ptr::null_mut::<state_t>();
    psp = (&raw mut (*player).psprites as *mut pspdef_t).offset(0 as ::core::ffi::c_int as isize)
        as *mut pspdef_t;
    i = 0 as ::core::ffi::c_int;
    while i < NUMPSPRITES as ::core::ffi::c_int {
        state = (*psp).state;
    ...
    (*player).psprites[ps_flash as ::core::ffi::c_int as usize].sx =
        (*player).psprites[ps_weapon as ::core::ffi::c_int as usize].sx;
    (*player).psprites[ps_flash as ::core::ffi::c_int as usize].sy =
        (*player).psprites[ps_weapon as ::core::ffi::c_int as usize].sy;
}
