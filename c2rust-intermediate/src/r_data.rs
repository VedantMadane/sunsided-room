...
#[no_mangle]
pub static mut textures: *mut *mut texture_t = ::core::ptr::null_mut::<*mut texture_t>();
#[no_mangle]
pub static mut textures_hashtable: *mut *mut texture_t = ::core::ptr::null_mut::<*mut texture_t>();
#[no_mangle]
pub static mut texturewidthmask: *mut ::core::ffi::c_int =
    ::core::ptr::null_mut::<::core::ffi::c_int>();
#[no_mangle]
pub static mut textureheight: *mut fixed_t = ::core::ptr::null_mut::<fixed_t>();
#[no_mangle]
pub static mut texturecompositesize: *mut ::core::ffi::c_int =
    ::core::ptr::null_mut::<::core::ffi::c_int>();
#[no_mangle]
pub static mut texturecolumnlump: *mut *mut ::core::ffi::c_short =
    ::core::ptr::null_mut::<*mut ::core::ffi::c_short>();
#[no_mangle]
pub static mut texturecolumnofs: *mut *mut ::core::ffi::c_ushort =
    ::core::ptr::null_mut::<*mut ::core::ffi::c_ushort>();
#[no_mangle]
pub static mut texturecomposite: *mut *mut byte = ::core::ptr::null_mut::<*mut byte>();
#[no_mangle]
pub static mut flattranslation: *mut ::core::ffi::c_int =
    ::core::ptr::null_mut::<::core::ffi::c_int>();
#[no_mangle]
pub static mut texturetranslation: *mut ::core::ffi::c_int =
    ::core::ptr::null_mut::<::core::ffi::c_int>();
#[no_mangle]
pub static mut spritewidth: *mut fixed_t = ::core::ptr::null_mut::<fixed_t>();
#[no_mangle]
pub static mut spriteoffset: *mut fixed_t = ::core::ptr::null_mut::<fixed_t>();
#[no_mangle]
pub static mut spritetopoffset: *mut fixed_t = ::core::ptr::null_mut::<fixed_t>();
#[no_mangle]
pub static mut colormaps: *mut lighttable_t = ::core::ptr::null_mut::<lighttable_t>();
#[no_mangle]
...
pub unsafe extern "C" fn R_GenerateComposite(mut texnum: ::core::ffi::c_int) {
    ...
    let mut collump: *mut ::core::ffi::c_short = ::core::ptr::null_mut::<::core::ffi::c_short>();
    let mut colofs: *mut ::core::ffi::c_ushort = ::core::ptr::null_mut::<::core::ffi::c_ushort>();
    ...
    while i < (*texture).patchcount as ::core::ffi::c_int {
        realpatch = W_CacheLumpNum((*patch).patch, PU_CACHE as ::core::ffi::c_int) as *mut patch_t;
        ...
        while x < x2 {
            if !(*collump.offset(x as isize) as ::core::ffi::c_int >= 0 as ::core::ffi::c_int) {
                patchcol = (realpatch as *mut byte)
                    .offset((*realpatch).columnofs[(x - x1) as usize] as isize)
                    as *mut column_t;
                R_DrawColumnInCache(
                    patchcol,
                    block.offset(*colofs.offset(x as isize) as ::core::ffi::c_int as isize),
    ...
    Z_ChangeTag2(
        ...
        b"vendor/doomgeneric/r_data.c\0".as_ptr() as *const ::core::ffi::c_char
...
pub unsafe extern "C" fn R_GenerateLookup(mut texnum: ::core::ffi::c_int) {
    ...
    let mut colofs: *mut ::core::ffi::c_ushort = ::core::ptr::null_mut::<::core::ffi::c_ushort>();
    texture = *textures.offset(texnum as isize);
    let ref mut c2rust_fresh4 = *texturecomposite.offset(texnum as isize);
    *c2rust_fresh4 = ::core::ptr::null_mut::<byte>();
    *texturecompositesize.offset(texnum as isize) = 0 as ::core::ffi::c_int;
    ...
    while i < (*texture).patchcount as ::core::ffi::c_int {
        ...
        while x < x2 {
            let ref mut c2rust_fresh5 = *patchcount.offset(x as isize);
            *c2rust_fresh5 = (*c2rust_fresh5).wrapping_add(1);
    ...
    while x < (*texture).width as ::core::ffi::c_int {
        ...
        if *patchcount.offset(x as isize) as ::core::ffi::c_int > 1 as ::core::ffi::c_int {
            *collump.offset(x as isize) = -1 as ::core::ffi::c_short;
            *colofs.offset(x as isize) =
                *texturecompositesize.offset(texnum as isize) as ::core::ffi::c_ushort;
                ...
                > 0x10000 as ::core::ffi::c_int - (*texture).height as ::core::ffi::c_int
            {
                ...
                snprintf(
                    ...
                    b"R_GenerateLookup: texture %i is >64k\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    texnum,
                );
...
pub unsafe extern "C" fn R_GetColumn(
    ...
    lump = *(*texturecolumnlump.offset(tex as isize)).offset(col as isize) as ::core::ffi::c_int;
    ofs = *(*texturecolumnofs.offset(tex as isize)).offset(col as isize) as ::core::ffi::c_int;
...
unsafe extern "C" fn GenerateTextureHashTable() {
    ...
    while i < numtextures {
        ...
        let ref mut c2rust_fresh3 = (**textures.offset(i as isize)).next;
        *c2rust_fresh3 = ::core::ptr::null_mut::<texture_t>();
...
pub unsafe extern "C" fn R_InitTextures() {
    ...
    let mut maptex: *mut ::core::ffi::c_int = ::core::ptr::null_mut::<::core::ffi::c_int>();
    let mut maptex2: *mut ::core::ffi::c_int = ::core::ptr::null_mut::<::core::ffi::c_int>();
    let mut maptex1: *mut ::core::ffi::c_int = ::core::ptr::null_mut::<::core::ffi::c_int>();
    ...
    let mut patchlookup: *mut ::core::ffi::c_int = ::core::ptr::null_mut::<::core::ffi::c_int>();
    ...
    let mut directory: *mut ::core::ffi::c_int = ::core::ptr::null_mut::<::core::ffi::c_int>();
    ...
    names = W_CacheLumpName(
        b"PNAMES\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        PU_STATIC as ::core::ffi::c_int,
    ) as *mut ::core::ffi::c_char;
    nummappatches = *(names as *mut ::core::ffi::c_int);
    name_p = names.offset(4 as ::core::ffi::c_int as isize);
    patchlookup = Z_Malloc(
        (nummappatches as usize).wrapping_mul(::core::mem::size_of::<::core::ffi::c_int>() as usize)
            as ::core::ffi::c_int,
        PU_STATIC as ::core::ffi::c_int,
        NULL,
    ...
    while i < nummappatches {
        ...
        *patchlookup.offset(i as isize) =
            W_CheckNumForName(&raw mut name as *mut ::core::ffi::c_char);
        i += 1;
    }
    W_ReleaseLumpName(
        b"PNAMES\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
    ...
    maptex1 = W_CacheLumpName(
        b"TEXTURE1\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char,
        PU_STATIC as ::core::ffi::c_int,
    ) as *mut ::core::ffi::c_int;
    maptex = maptex1;
    numtextures1 = *maptex;
    maxoff = W_LumpLength(W_GetNumForName(
        b"TEXTURE1\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
    ) as ::core::ffi::c_uint);
    directory = maptex.offset(1 as ::core::ffi::c_int as isize);
    if W_CheckNumForName(
        b"TEXTURE2\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
    ) != -1 as ::core::ffi::c_int
    {
        ...
        maxoff2 = W_LumpLength(W_GetNumForName(
            b"TEXTURE2\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
        ) as ::core::ffi::c_uint);
    } else {
    ...
    texturecompositesize = Z_Malloc(
        (numtextures as usize).wrapping_mul(::core::mem::size_of::<::core::ffi::c_int>() as usize)
            as ::core::ffi::c_int,
        PU_STATIC as ::core::ffi::c_int,
        ::core::ptr::null_mut::<::core::ffi::c_void>(),
    ) as *mut ::core::ffi::c_int;
    ...
    temp1 = W_GetNumForName(
        b"S_START\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
    );
    temp2 = W_GetNumForName(
        b"S_END\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
    ) - 1 as ::core::ffi::c_int;
    ...
    if I_ConsoleStdout() != 0 {
        ...
        while i < temp3 + 10 as ::core::ffi::c_int {
            printf(b"\x08\0".as_ptr() as *const ::core::ffi::c_char);
            i += 1;
        }
    }
    i = 0 as ::core::ffi::c_int;
    while i < numtextures {
        ...
        if offset > maxoff {
            ...
            snprintf(
                &raw mut _i_err_buf as *mut ::core::ffi::c_char,
                ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
                b"R_InitTextures: bad texture directory\0".as_ptr() as *const ::core::ffi::c_char,
            );
            I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
        }
        mtexture = (maptex as *mut byte).offset(offset as isize) as *mut maptexture_t;
        let ref mut c2rust_fresh0 = *textures.offset(i as isize);
        *c2rust_fresh0 = Z_Malloc(
            (::core::mem::size_of::<texture_t>() as usize).wrapping_add(
                (::core::mem::size_of::<texpatch_t>() as usize).wrapping_mul(
                    ((*mtexture).patchcount as ::core::ffi::c_int - 1 as ::core::ffi::c_int)
                        as usize,
                ),
            ) as ::core::ffi::c_int,
            PU_STATIC as ::core::ffi::c_int,
        ...
        while j < (*texture).patchcount as ::core::ffi::c_int {
            ...
            if (*patch).patch == -1 as ::core::ffi::c_int {
                ...
                snprintf(
                    ...
                    ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
                    b"R_InitTextures: Missing patch in texture %s\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    &raw mut (*texture).name as *mut ::core::ffi::c_char,
                );
        ...
        let ref mut c2rust_fresh1 = *texturecolumnlump.offset(i as isize);
        *c2rust_fresh1 = Z_Malloc(
        ...
        let ref mut c2rust_fresh2 = *texturecolumnofs.offset(i as isize);
        *c2rust_fresh2 = Z_Malloc(
            ((*texture).width as usize)
        ...
        *textureheight.offset(i as isize) =
            (((*texture).height as ::core::ffi::c_int) << FRACBITS) as fixed_t;
...
pub unsafe extern "C" fn R_InitFlats() {
    ...
    firstflat = W_GetNumForName(
        b"F_START\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
    ) + 1 as ::core::ffi::c_int;
    lastflat = W_GetNumForName(
        b"F_END\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
    ) - 1 as ::core::ffi::c_int;
...
pub unsafe extern "C" fn R_InitSpriteLumps() {
    ...
    spritewidth = Z_Malloc(
        (numspritelumps as usize).wrapping_mul(::core::mem::size_of::<fixed_t>() as usize)
            as ::core::ffi::c_int,
        PU_STATIC as ::core::ffi::c_int,
        ::core::ptr::null_mut::<::core::ffi::c_void>(),
    ) as *mut fixed_t;
    ...
    while i < numspritelumps {
        ...
        patch = W_CacheLumpNum(firstspritelump + i, PU_CACHE as ::core::ffi::c_int) as *mut patch_t;
        *spritewidth.offset(i as isize) =
            (((*patch).width as ::core::ffi::c_int) << FRACBITS) as fixed_t;
        *spriteoffset.offset(i as isize) =
            (((*patch).leftoffset as ::core::ffi::c_int) << FRACBITS) as fixed_t;
        *spritetopoffset.offset(i as isize) =
            (((*patch).topoffset as ::core::ffi::c_int) << FRACBITS) as fixed_t;
        i += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn R_InitColormaps() {
    ...
    lump = W_GetNumForName(
        b"COLORMAP\0".as_ptr() as *const ::core::ffi::c_char as *mut ::core::ffi::c_char
    );
    colormaps = W_CacheLumpNum(lump, PU_STATIC as ::core::ffi::c_int) as *mut lighttable_t;
}
#[no_mangle]
...
pub unsafe extern "C" fn R_FlatNumForName(
    ...
    if i == -1 as ::core::ffi::c_int {
        ...
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_FlatNumForName: %s not found\0".as_ptr() as *const ::core::ffi::c_char,
...
pub unsafe extern "C" fn R_CheckTextureNumForName(
    ...
    key =
        W_LumpNameHash(name).wrapping_rem(numtextures as ::core::ffi::c_uint) as ::core::ffi::c_int;
...
pub unsafe extern "C" fn R_TextureNumForName(
    ...
    if i == -1 as ::core::ffi::c_int {
        ...
        snprintf(
            &raw mut _i_err_buf as *mut ::core::ffi::c_char,
            ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
            b"R_TextureNumForName: %s not found\0".as_ptr() as *const ::core::ffi::c_char,
            name,
        );
        I_ErrorV(&raw mut _i_err_buf as *mut ::core::ffi::c_char);
    }
...
pub unsafe extern "C" fn R_PrecacheLevel() {
    ...
    flatpresent =
        Z_Malloc(numflats, PU_STATIC as ::core::ffi::c_int, NULL) as *mut ::core::ffi::c_char;
    memset(
    ...
    texturepresent =
        Z_Malloc(numtextures, PU_STATIC as ::core::ffi::c_int, NULL) as *mut ::core::ffi::c_char;
    memset(
    ...
    *texturepresent.offset(skytexture as isize) = 1 as ::core::ffi::c_char;
    ...
    spritepresent =
        Z_Malloc(numsprites, PU_STATIC as ::core::ffi::c_int, NULL) as *mut ::core::ffi::c_char;
    memset(
        ...
        if !(*spritepresent.offset(i as isize) == 0) {
            ...
            while j < (*sprites.offset(i as isize)).numframes {
                ...
                while k < 8 as ::core::ffi::c_int {
                    lump = firstspritelump + (*sf).lump[k as usize] as ::core::ffi::c_int;
