...
This project is indexed by GitNexus as **room** (72190 symbols, 88382 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
